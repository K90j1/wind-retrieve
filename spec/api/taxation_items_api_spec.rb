...
# Unit tests for SwaggerClient::TaxationItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxationItemsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TaxationItemsApi.new
  end
  ...
  describe 'test an instance of TaxationItemsApi' do
    it 'should create an instact of TaxationItemsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::TaxationItemsApi)
    end
  end

  # unit tests for proxy_delete_taxation_item
  # CRUD: Delete TaxationItem
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_taxation_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_taxation_item
  ...
  describe 'proxy_get_taxation_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_taxation_item
  # CRUD: Create TaxationItem
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_taxation_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_taxation_item
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_taxation_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
