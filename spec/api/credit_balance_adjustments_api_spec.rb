...
# Unit tests for SwaggerClient::CreditBalanceAdjustmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditBalanceAdjustmentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CreditBalanceAdjustmentsApi.new
  end
  ...
  describe 'test an instance of CreditBalanceAdjustmentsApi' do
    it 'should create an instact of CreditBalanceAdjustmentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CreditBalanceAdjustmentsApi)
    end
  end

  # unit tests for proxy_delete_credit_balance_adjustment
  # CRUD: Delete CreditBalanceAdjustment
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_credit_balance_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_credit_balance_adjustment
  ...
  describe 'proxy_get_credit_balance_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
