...
# Unit tests for SwaggerClient::CommunicationProfilesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationProfilesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CommunicationProfilesApi.new
  end
  ...
  describe 'test an instance of CommunicationProfilesApi' do
    it 'should create an instact of CommunicationProfilesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CommunicationProfilesApi)
    end
  end

  # unit tests for proxy_delete_communication_profile
  # CRUD: Delete CommunicationProfile
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_communication_profile test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_communication_profile
  ...
  describe 'proxy_get_communication_profile test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
