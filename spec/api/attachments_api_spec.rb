...
describe 'AttachmentsApi' do
  ...
  # unit tests for d_elete_attachments
  # Delete attachments
  ...
  describe 'd_elete_attachments test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_attachments
  # View attachments
  ...
  describe 'g_et_attachments test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_attachments_response
  ...
  describe 'g_et_attachments_response test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_attachments
  # Add attachments
  ...
  describe 'p_ost_attachments test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_attachments
  # Edit attachments
  ...
  # @return [CommonResponseType]
  describe 'p_ut_attachments test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
