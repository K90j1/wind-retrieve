...
# Unit tests for SwaggerClient::PaymentMethodSnapshotsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodSnapshotsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentMethodSnapshotsApi.new
  end
  ...
  describe 'test an instance of PaymentMethodSnapshotsApi' do
    it 'should create an instact of PaymentMethodSnapshotsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentMethodSnapshotsApi)
    end
  end

  # unit tests for proxy_delete_payment_method_snapshot
  # CRUD: Delete PaymentMethodSnapshot
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_payment_method_snapshot test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_payment_method_snapshot
  ...
  describe 'proxy_get_payment_method_snapshot test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
