...
describe 'RevenueSchedulesApi' do
  ...
  describe 'test an instance of RevenueSchedulesApi' do
    it 'should create an instact of RevenueSchedulesApi' do
  ...
  # @param [Hash] opts the optional parameters
  # @return [GETRSDetailType]
  describe 'g_etrs_detail test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_etrs_details_by_charge
  ...
  describe 'g_etrs_details_by_charge test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_revenue_schedule_by_charge_response
  ...
  describe 'p_ost_revenue_schedule_by_charge_response test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
