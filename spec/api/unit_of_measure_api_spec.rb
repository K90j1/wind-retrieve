...
# Unit tests for SwaggerClient::UnitOfMeasureApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnitOfMeasureApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UnitOfMeasureApi.new
  end
  ...
  describe 'test an instance of UnitOfMeasureApi' do
    it 'should create an instact of UnitOfMeasureApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UnitOfMeasureApi)
    end
  end

  # unit tests for proxy_delete_unit_of_measure
  # CRUD: Delete UnitOfMeasure
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_unit_of_measure test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_unit_of_measure
  ...
  describe 'proxy_get_unit_of_measure test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_unit_of_measure
  # CRUD: Create UnitOfMeasure
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_unit_of_measure test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_unit_of_measure
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_unit_of_measure test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
