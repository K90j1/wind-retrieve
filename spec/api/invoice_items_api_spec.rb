...
# Unit tests for SwaggerClient::InvoiceItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceItemsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InvoiceItemsApi.new
  end
  ...
  describe 'test an instance of InvoiceItemsApi' do
    it 'should create an instact of InvoiceItemsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InvoiceItemsApi)
    end
  end

  # unit tests for proxy_delete_invoice_item
  # CRUD: Delete InvoiceItem
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_invoice_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_invoice_item
  ...
  describe 'proxy_get_invoice_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
