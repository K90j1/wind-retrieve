...
# Unit tests for SwaggerClient::JournalRunsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JournalRunsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::JournalRunsApi.new
  end
  ...
  describe 'test an instance of JournalRunsApi' do
    it 'should create an instact of JournalRunsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::JournalRunsApi)
    end
  end

  # unit tests for d_elete_journal_run
  # Delete journal run
  ...
  describe 'd_elete_journal_run test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_journal_run
  # Get journal run
  ...
  describe 'g_et_journal_run test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_journal_run
  # Create journal run
  ...
  describe 'p_ost_journal_run test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_journal_run
  # Cancel journal run
  ...
  # @param [Hash] opts the optional parameters
  # @return [CommonResponseType]
  describe 'p_ut_journal_run test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
