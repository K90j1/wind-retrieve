...
describe 'UsageApi' do
  ...
  describe 'g_et_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_usage
  # Post usage
  ...
  describe 'p_ost_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_delete_usage
  # CRUD: Delete Usage
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_usage
  # CRUD: Retrieve Usage
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  ...
  describe 'proxy_get_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_usage
  # CRUD: Create Usage
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_usage
  # CRUD: Update Usage
  # 
  # @param id Object id
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_usage test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
