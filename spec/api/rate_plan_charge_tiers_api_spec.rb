...
# Unit tests for SwaggerClient::RatePlanChargeTiersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatePlanChargeTiersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RatePlanChargeTiersApi.new
  end
  ...
  describe 'test an instance of RatePlanChargeTiersApi' do
    it 'should create an instact of RatePlanChargeTiersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RatePlanChargeTiersApi)
    end
  end

  # unit tests for proxy_delete_rate_plan_charge_tier
  # CRUD: Delete RatePlanChargeTier
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_rate_plan_charge_tier test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_rate_plan_charge_tier
  ...
  describe 'proxy_get_rate_plan_charge_tier test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
