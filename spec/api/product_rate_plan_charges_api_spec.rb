...
# Unit tests for SwaggerClient::ProductRatePlanChargesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductRatePlanChargesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ProductRatePlanChargesApi.new
  end
  ...
  describe 'test an instance of ProductRatePlanChargesApi' do
    it 'should create an instact of ProductRatePlanChargesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ProductRatePlanChargesApi)
    end
  end

  # unit tests for proxy_delete_product_rate_plan_charge
  # CRUD: Delete ProductRatePlanCharge
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_product_rate_plan_charge test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_product_rate_plan_charge
  ...
  describe 'proxy_get_product_rate_plan_charge test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
