...
# Unit tests for SwaggerClient::RatePlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatePlansApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RatePlansApi.new
  end
  ...
  describe 'test an instance of RatePlansApi' do
    it 'should create an instact of RatePlansApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RatePlansApi)
    end
  end

  # unit tests for proxy_delete_rate_plan
  # CRUD: Delete RatePlan
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_rate_plan
  ...
  describe 'proxy_get_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
