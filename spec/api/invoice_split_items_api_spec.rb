...
# Unit tests for SwaggerClient::InvoiceSplitItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceSplitItemsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InvoiceSplitItemsApi.new
  end
  ...
  describe 'test an instance of InvoiceSplitItemsApi' do
    it 'should create an instact of InvoiceSplitItemsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InvoiceSplitItemsApi)
    end
  end

  # unit tests for proxy_delete_invoice_split_item
  # CRUD: Delete InvoiceSplitItem
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_invoice_split_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_invoice_split_item
  ...
  describe 'proxy_get_invoice_split_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
