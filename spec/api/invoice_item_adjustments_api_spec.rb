...
# Unit tests for SwaggerClient::InvoiceItemAdjustmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceItemAdjustmentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InvoiceItemAdjustmentsApi.new
  end
  ...
  describe 'test an instance of InvoiceItemAdjustmentsApi' do
    it 'should create an instact of InvoiceItemAdjustmentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InvoiceItemAdjustmentsApi)
    end
  end

  # unit tests for proxy_delete_invoice_item_adjustment
  # CRUD: Delete InvoiceItemAdjustment
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_invoice_item_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_invoice_item_adjustment
  ...
  describe 'proxy_get_invoice_item_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
