...
# Unit tests for SwaggerClient::RevenueItemsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RevenueItemsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RevenueItemsApi.new
  end
  ...
  describe 'test an instance of RevenueItemsApi' do
    it 'should create an instact of RevenueItemsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RevenueItemsApi)
    end
  end

  # unit tests for g_et_revenue_items_by_charge_revenue_event_number
  ...
  describe 'g_et_revenue_items_by_charge_revenue_event_number test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_revenue_items_by_charge_revenue_summary_number
  ...
  # @param [Hash] opts the optional parameters
  # @return [GETRevenueItemsType]
  describe 'g_et_revenue_items_by_charge_revenue_summary_number test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_revenue_items_by_revenue_schedule
  ...
  describe 'g_et_revenue_items_by_revenue_schedule test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_custom_fieldson_revenue_items_by_revenue_event
  ...
  describe 'p_ut_custom_fieldson_revenue_items_by_revenue_event test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_custom_fieldson_revenue_items_by_revenue_schedule
  ...
  # @param [Hash] opts the optional parameters
  # @return [CommonResponseType]
  describe 'p_ut_custom_fieldson_revenue_items_by_revenue_schedule test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
