...
# Unit tests for SwaggerClient::InvoiceAdjustmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceAdjustmentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InvoiceAdjustmentsApi.new
  end
  ...
  describe 'test an instance of InvoiceAdjustmentsApi' do
    it 'should create an instact of InvoiceAdjustmentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InvoiceAdjustmentsApi)
    end
  end

  # unit tests for proxy_delete_invoice_adjustment
  # CRUD: Delete InvoiceAdjustment
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_invoice_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_invoice_adjustment
  ...
  describe 'proxy_get_invoice_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_invoice_adjustment
  # CRUD: Create InvoiceAdjustment
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_invoice_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_invoice_adjustment
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_invoice_adjustment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
