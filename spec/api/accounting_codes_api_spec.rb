...
# Unit tests for SwaggerClient::AccountingCodesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountingCodesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountingCodesApi.new
  end
  ...
  describe 'test an instance of AccountingCodesApi' do
    it 'should create an instact of AccountingCodesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountingCodesApi)
    end
  end

  # unit tests for d_elete_accounting_code
  ...
  describe 'd_elete_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_accounting_code_item
  ...
  describe 'g_et_accounting_code_item test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_accounting_codes
  ...
  describe 'g_et_accounting_codes test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_accounting_code
  ...
  describe 'p_ost_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_accounting_code
  ...
  # @param [Hash] opts the optional parameters
  # @return [CommonResponseType]
  describe 'p_ut_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_activate_accounting_code
  ...
  # @param [Hash] opts the optional parameters
  # @return [CommonResponseType]
  describe 'p_ut_activate_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_deactivate_accounting_code
  ...
  # @param [Hash] opts the optional parameters
  # @return [CommonResponseType]
  describe 'p_ut_deactivate_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_delete_accounting_code
  # CRUD: Delete AccountingCode
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_accounting_code
  ...
  describe 'proxy_get_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_accounting_code
  # CRUD: Create AccountingCode
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_accounting_code
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_accounting_code test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
