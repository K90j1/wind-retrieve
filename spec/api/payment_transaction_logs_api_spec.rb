...
# Unit tests for SwaggerClient::PaymentTransactionLogsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentTransactionLogsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentTransactionLogsApi.new
  end
  ...
  describe 'test an instance of PaymentTransactionLogsApi' do
    it 'should create an instact of PaymentTransactionLogsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentTransactionLogsApi)
    end
  end

  # unit tests for proxy_delete_payment_transaction_log
  # CRUD: Delete PaymentTransactionLog
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_payment_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_payment_transaction_log
  ...
  describe 'proxy_get_payment_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
