...
# Unit tests for SwaggerClient::ProductFeaturesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductFeaturesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ProductFeaturesApi.new
  end
  ...
  describe 'test an instance of ProductFeaturesApi' do
    it 'should create an instact of ProductFeaturesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ProductFeaturesApi)
    end
  end

  # unit tests for proxy_delete_product_feature
  # CRUD: Delete ProductFeature
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_product_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_product_feature
  ...
  describe 'proxy_get_product_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
