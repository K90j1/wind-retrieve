...
# Unit tests for SwaggerClient::SubscriptionProductFeaturesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionProductFeaturesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscriptionProductFeaturesApi.new
  end
  ...
  describe 'test an instance of SubscriptionProductFeaturesApi' do
    it 'should create an instact of SubscriptionProductFeaturesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscriptionProductFeaturesApi)
    end
  end

  # unit tests for proxy_delete_subscription_product_feature
  # CRUD: Delete SubscriptionProductFeature
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_subscription_product_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_subscription_product_feature
  ...
  describe 'proxy_get_subscription_product_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
