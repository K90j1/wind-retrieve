...
# Unit tests for SwaggerClient::RefundTransactionLogsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundTransactionLogsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundTransactionLogsApi.new
  end
  ...
  describe 'test an instance of RefundTransactionLogsApi' do
    it 'should create an instact of RefundTransactionLogsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundTransactionLogsApi)
    end
  end

  # unit tests for proxy_delete_refund_transaction_log
  # CRUD: Delete RefundTransactionLog
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_refund_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_refund_transaction_log
  ...
  describe 'proxy_get_refund_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
