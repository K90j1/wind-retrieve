...
describe 'FeaturesApi' do
  ...
  describe 'test an instance of FeaturesApi' do
    it 'should create an instact of FeaturesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::FeaturesApi)
    end
  end

  # unit tests for proxy_delete_feature
  # CRUD: Delete Feature
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_feature
  ...
  describe 'proxy_get_feature test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
