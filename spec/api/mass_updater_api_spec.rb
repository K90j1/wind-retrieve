...
# Unit tests for SwaggerClient::MassUpdaterApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MassUpdaterApi' do
  before do
    # run before each test
    @instance = SwaggerClient::MassUpdaterApi.new
  end
  ...
  describe 'test an instance of MassUpdaterApi' do
    it 'should create an instact of MassUpdaterApi' do
      expect(@instance).to be_instance_of(SwaggerClient::MassUpdaterApi)
    end
  end

  # unit tests for g_et_mass_update
  ...
  describe 'g_et_mass_update test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_mass_update
  # Perform mass action
  ...
  describe 'p_ost_mass_update test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_mass_updater
  # Stop mass action
  ...
  describe 'p_ut_mass_updater test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
