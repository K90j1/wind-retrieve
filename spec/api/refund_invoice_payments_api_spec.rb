...
# Unit tests for SwaggerClient::RefundInvoicePaymentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundInvoicePaymentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundInvoicePaymentsApi.new
  end
  ...
  describe 'test an instance of RefundInvoicePaymentsApi' do
    it 'should create an instact of RefundInvoicePaymentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundInvoicePaymentsApi)
    end
  end

  # unit tests for proxy_delete_refund_invoice_payment
  # CRUD: Delete RefundInvoicePayment
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_refund_invoice_payment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_refund_invoice_payment
  ...
  describe 'proxy_get_refund_invoice_payment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
