...
describe 'AccountsApi' do
  ...
  # unit tests for g_et_account_summary
  # Get account summary
  ...
  describe 'g_et_account_summary test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ost_account
  # Create account
  ...
  describe 'p_ost_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p_ut_account
  # Update account
  ...
  describe 'p_ut_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_delete_account
  # CRUD: Delete Account
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_account
  ...
  describe 'proxy_get_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_account
  # CRUD: Create Account
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_account
  # CRUD: Update Account
  # 
  # @param id Object id
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_account test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
