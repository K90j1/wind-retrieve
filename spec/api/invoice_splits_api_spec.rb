...
# Unit tests for SwaggerClient::InvoiceSplitsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceSplitsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::InvoiceSplitsApi.new
  end
  ...
  describe 'test an instance of InvoiceSplitsApi' do
    it 'should create an instact of InvoiceSplitsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::InvoiceSplitsApi)
    end
  end

  # unit tests for proxy_delete_invoice_split
  # CRUD: Delete InvoiceSplit
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_invoice_split test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_invoice_split
  ...
  describe 'proxy_get_invoice_split test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
