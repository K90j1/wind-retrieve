...
# Unit tests for SwaggerClient::PaymentMethodTransactionLogsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodTransactionLogsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentMethodTransactionLogsApi.new
  end
  ...
  describe 'test an instance of PaymentMethodTransactionLogsApi' do
    it 'should create an instact of PaymentMethodTransactionLogsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentMethodTransactionLogsApi)
    end
  end

  # unit tests for proxy_delete_payment_method_transaction_log
  # CRUD: Delete PaymentMethodTransactionLog
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_payment_method_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_payment_method_transaction_log
  ...
  describe 'proxy_get_payment_method_transaction_log test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
