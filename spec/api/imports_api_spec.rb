...
# Unit tests for SwaggerClient::ImportsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ImportsApi.new
  end
  ...
  describe 'test an instance of ImportsApi' do
    it 'should create an instact of ImportsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ImportsApi)
    end
  end

  # unit tests for proxy_delete_import
  # CRUD: Delete Import
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_import test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_import
  ...
  describe 'proxy_get_import test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
