...
# Unit tests for SwaggerClient::ProductRatePlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductRatePlansApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ProductRatePlansApi.new
  end
  ...
  describe 'test an instance of ProductRatePlansApi' do
    it 'should create an instact of ProductRatePlansApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ProductRatePlansApi)
    end
  end

  # unit tests for proxy_delete_product_rate_plan
  # CRUD: Delete ProductRatePlan
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_product_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_product_rate_plan
  ...
  describe 'proxy_get_product_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_product_rate_plan
  # CRUD: Create ProductRatePlan
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_product_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_product_rate_plan
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_product_rate_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
