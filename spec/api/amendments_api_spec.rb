...
# Unit tests for SwaggerClient::AmendmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmendmentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AmendmentsApi.new
  end
  ...
  describe 'test an instance of AmendmentsApi' do
    it 'should create an instact of AmendmentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AmendmentsApi)
    end
  end

  # unit tests for g_et_amendment
  ...
  describe 'g_et_amendment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for g_et_amendments_by_subscription_id
  ...
  # @param [Hash] opts the optional parameters
  # @return [GETAmendmentType]
  describe 'g_et_amendments_by_subscription_id test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_delete_amendment
  # CRUD: Delete Amendment
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_amendment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_amendment
  ...
  describe 'proxy_get_amendment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_post_amendment
  # CRUD: Create Amendment
  # 
  # @param create_request 
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_post_amendment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_put_amendment
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProxyCreateOrModifyResponse]
  describe 'proxy_put_amendment test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
