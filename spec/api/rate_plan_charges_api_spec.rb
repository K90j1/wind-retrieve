...
# Unit tests for SwaggerClient::RatePlanChargesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatePlanChargesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RatePlanChargesApi.new
  end
  ...
  describe 'test an instance of RatePlanChargesApi' do
    it 'should create an instact of RatePlanChargesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RatePlanChargesApi)
    end
  end

  # unit tests for proxy_delete_rate_plan_charge
  # CRUD: Delete RatePlanCharge
  # 
  # @param id Object id
  # @param [Hash] opts the optional parameters
  # @return [ProxyDeleteResponse]
  describe 'proxy_delete_rate_plan_charge test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for proxy_get_rate_plan_charge
  ...
  describe 'proxy_get_rate_plan_charge test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
