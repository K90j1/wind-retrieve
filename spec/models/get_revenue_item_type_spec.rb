...
# Unit tests for SwaggerClient::GETRevenueItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRevenueItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRevenueItemType.new
  end
  ...
  describe 'test an instance of GETRevenueItemType' do
    it 'should create an instact of GETRevenueItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRevenueItemType)
    end
  end
