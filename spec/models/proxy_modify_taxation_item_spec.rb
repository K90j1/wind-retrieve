...
# Unit tests for SwaggerClient::ProxyModifyTaxationItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyTaxationItem' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyTaxationItem.new
  end
  ...
  describe 'test an instance of ProxyModifyTaxationItem' do
    it 'should create an instact of ProxyModifyTaxationItem' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyTaxationItem)
    end
  end
