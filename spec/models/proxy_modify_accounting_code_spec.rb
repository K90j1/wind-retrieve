...
# Unit tests for SwaggerClient::ProxyModifyAccountingCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyAccountingCode' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyAccountingCode.new
  end
  ...
  describe 'test an instance of ProxyModifyAccountingCode' do
    it 'should create an instact of ProxyModifyAccountingCode' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyAccountingCode)
    end
  end
