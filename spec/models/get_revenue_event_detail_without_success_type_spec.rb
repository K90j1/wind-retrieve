...
# Unit tests for SwaggerClient::GETRevenueEventDetailWithoutSuccessType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRevenueEventDetailWithoutSuccessType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRevenueEventDetailWithoutSuccessType.new
  end
  ...
  describe 'test an instance of GETRevenueEventDetailWithoutSuccessType' do
    it 'should create an instact of GETRevenueEventDetailWithoutSuccessType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRevenueEventDetailWithoutSuccessType)
    end
  end
