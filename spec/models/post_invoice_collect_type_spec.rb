...
# Unit tests for SwaggerClient::POSTInvoiceCollectType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTInvoiceCollectType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTInvoiceCollectType.new
  end
  ...
  describe 'test an instance of POSTInvoiceCollectType' do
    it 'should create an instact of POSTInvoiceCollectType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTInvoiceCollectType)
    end
  end
