...
# Unit tests for SwaggerClient::GETPaymentMethodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETPaymentMethodType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETPaymentMethodType.new
  end
  ...
  describe 'test an instance of GETPaymentMethodType' do
    it 'should create an instact of GETPaymentMethodType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETPaymentMethodType)
    end
  end
