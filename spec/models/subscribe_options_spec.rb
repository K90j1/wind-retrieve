...
# Unit tests for SwaggerClient::SubscribeOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscribeOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscribeOptions.new
  end
  ...
  describe 'test an instance of SubscribeOptions' do
    it 'should create an instact of SubscribeOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscribeOptions)
    end
  end
  ...
  describe 'test attribute "electronic_payment_options"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "external_payment_options"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "process_payments"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "subscribe_invoice_processing_options"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
