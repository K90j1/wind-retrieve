...
# Unit tests for SwaggerClient::ProxyGetAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetAmendment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetAmendment.new
  end
  ...
  describe 'test an instance of ProxyGetAmendment' do
    it 'should create an instact of ProxyGetAmendment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetAmendment)
    end
  end
