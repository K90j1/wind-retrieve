...
# Unit tests for SwaggerClient::ProxyGetCommunicationProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetCommunicationProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetCommunicationProfile.new
  end
  ...
  describe 'test an instance of ProxyGetCommunicationProfile' do
    it 'should create an instact of ProxyGetCommunicationProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetCommunicationProfile)
    end
  end
