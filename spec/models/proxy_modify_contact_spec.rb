...
# Unit tests for SwaggerClient::ProxyModifyContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyContact' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyContact.new
  end
  ...
  describe 'test an instance of ProxyModifyContact' do
    it 'should create an instact of ProxyModifyContact' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyContact)
    end
  end
