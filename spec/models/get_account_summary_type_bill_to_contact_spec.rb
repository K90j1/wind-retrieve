...
# Unit tests for SwaggerClient::GETAccountSummaryTypeBillToContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryTypeBillToContact' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryTypeBillToContact.new
  end
  ...
  describe 'test an instance of GETAccountSummaryTypeBillToContact' do
    it 'should create an instact of GETAccountSummaryTypeBillToContact' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryTypeBillToContact)
    end
  end
