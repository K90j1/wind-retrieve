...
# Unit tests for SwaggerClient::ProxyGetContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetContact' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetContact.new
  end
  ...
  describe 'test an instance of ProxyGetContact' do
    it 'should create an instact of ProxyGetContact' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetContact)
    end
  end
