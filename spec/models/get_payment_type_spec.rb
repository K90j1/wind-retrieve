...
# Unit tests for SwaggerClient::GETPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETPaymentType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETPaymentType.new
  end
  ...
  describe 'test an instance of GETPaymentType' do
    it 'should create an instact of GETPaymentType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETPaymentType)
    end
  end
  ...
  describe 'test attribute "gateway_transaction_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
