...
# Unit tests for SwaggerClient::ProxyGetUsage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetUsage' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetUsage.new
  end
  ...
  describe 'test an instance of ProxyGetUsage' do
    it 'should create an instact of ProxyGetUsage' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetUsage)
    end
  end
