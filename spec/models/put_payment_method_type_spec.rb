...
# Unit tests for SwaggerClient::PUTPaymentMethodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTPaymentMethodType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTPaymentMethodType.new
  end
  ...
  describe 'test an instance of PUTPaymentMethodType' do
    it 'should create an instact of PUTPaymentMethodType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTPaymentMethodType)
    end
  end
