...
# Unit tests for SwaggerClient::POSTJournalRunType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTJournalRunType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTJournalRunType.new
  end
  ...
  describe 'test an instance of POSTJournalRunType' do
    it 'should create an instact of POSTJournalRunType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTJournalRunType)
    end
  end
