...
# Unit tests for SwaggerClient::GETProductRatePlanChargePricingType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETProductRatePlanChargePricingType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETProductRatePlanChargePricingType.new
  end
  ...
  describe 'test an instance of GETProductRatePlanChargePricingType' do
    it 'should create an instact of GETProductRatePlanChargePricingType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETProductRatePlanChargePricingType)
    end
  end
