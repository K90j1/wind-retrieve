...
# Unit tests for SwaggerClient::ProxyModifyAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyAmendment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyAmendment.new
  end
  ...
  describe 'test an instance of ProxyModifyAmendment' do
    it 'should create an instact of ProxyModifyAmendment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyAmendment)
    end
  end
