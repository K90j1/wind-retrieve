...
# Unit tests for SwaggerClient::GETProductRatePlanType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETProductRatePlanType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETProductRatePlanType.new
  end
  ...
  describe 'test an instance of GETProductRatePlanType' do
    it 'should create an instact of GETProductRatePlanType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETProductRatePlanType)
    end
  end
  ...
  describe 'test attribute "product_rate_plan_charges"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
