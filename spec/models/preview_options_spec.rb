...
# Unit tests for SwaggerClient::PreviewOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PreviewOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::PreviewOptions.new
  end
  ...
  describe 'test an instance of PreviewOptions' do
    it 'should create an instact of PreviewOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::PreviewOptions)
    end
  end
  describe 'test attribute "enable_preview_mode"' do
    it 'should work' do
  ...
  describe 'test attribute "preview_through_term_end"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
