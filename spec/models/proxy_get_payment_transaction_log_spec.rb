...
# Unit tests for SwaggerClient::ProxyGetPaymentTransactionLog
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetPaymentTransactionLog' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetPaymentTransactionLog.new
  end
  ...
  describe 'test an instance of ProxyGetPaymentTransactionLog' do
    it 'should create an instact of ProxyGetPaymentTransactionLog' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetPaymentTransactionLog)
    end
  end
  describe 'test attribute "avs_response_code"' do
    it 'should work' do
  ...
  describe 'test attribute "cvv_response_code"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "gateway_reason_code"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "gateway_reason_code_description"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "gateway_transaction_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "request_string"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "response_string"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
