...
# Unit tests for SwaggerClient::ProxyModifySubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifySubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifySubscription.new
  end
  ...
  describe 'test an instance of ProxyModifySubscription' do
    it 'should create an instact of ProxyModifySubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifySubscription)
    end
  end
