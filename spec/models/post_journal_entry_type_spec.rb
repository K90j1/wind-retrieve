...
# Unit tests for SwaggerClient::POSTJournalEntryType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTJournalEntryType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTJournalEntryType.new
  end
  ...
  describe 'test an instance of POSTJournalEntryType' do
    it 'should create an instact of POSTJournalEntryType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTJournalEntryType)
    end
  end
