...
# Unit tests for SwaggerClient::GETAccountSummaryTypeBasicInfoDefaultPaymentMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryTypeBasicInfoDefaultPaymentMethod' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryTypeBasicInfoDefaultPaymentMethod.new
  end
  ...
  describe 'test an instance of GETAccountSummaryTypeBasicInfoDefaultPaymentMethod' do
    it 'should create an instact of GETAccountSummaryTypeBasicInfoDefaultPaymentMethod' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryTypeBasicInfoDefaultPaymentMethod)
    end
  end
