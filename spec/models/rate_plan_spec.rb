...
# Unit tests for SwaggerClient::RatePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatePlan' do
  before do
    # run before each test
    @instance = SwaggerClient::RatePlan.new
  end
  ...
  describe 'test an instance of RatePlan' do
    it 'should create an instact of RatePlan' do
      expect(@instance).to be_instance_of(SwaggerClient::RatePlan)
    end
  end
  ...
  describe 'test attribute "amendment_subscription_rate_plan_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
