...
# Unit tests for SwaggerClient::ProxyGetAccountingCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetAccountingCode' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetAccountingCode.new
  end
  ...
  describe 'test an instance of ProxyGetAccountingCode' do
    it 'should create an instact of ProxyGetAccountingCode' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetAccountingCode)
    end
  end
