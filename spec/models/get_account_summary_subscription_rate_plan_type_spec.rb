...
# Unit tests for SwaggerClient::GETAccountSummarySubscriptionRatePlanType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummarySubscriptionRatePlanType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummarySubscriptionRatePlanType.new
  end
  ...
  describe 'test an instance of GETAccountSummarySubscriptionRatePlanType' do
    it 'should create an instact of GETAccountSummarySubscriptionRatePlanType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummarySubscriptionRatePlanType)
    end
  end
