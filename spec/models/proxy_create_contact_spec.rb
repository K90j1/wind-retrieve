...
# Unit tests for SwaggerClient::ProxyCreateContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateContact' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateContact.new
  end
  ...
  describe 'test an instance of ProxyCreateContact' do
    it 'should create an instact of ProxyCreateContact' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateContact)
    end
  end
