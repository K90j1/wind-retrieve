...
# Unit tests for SwaggerClient::ProxyCreateProductRatePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateProductRatePlan' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateProductRatePlan.new
  end
  ...
  describe 'test an instance of ProxyCreateProductRatePlan' do
    it 'should create an instact of ProxyCreateProductRatePlan' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateProductRatePlan)
    end
  end
