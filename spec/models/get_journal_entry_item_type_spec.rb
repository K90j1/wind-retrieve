...
# Unit tests for SwaggerClient::GETJournalEntryItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETJournalEntryItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETJournalEntryItemType.new
  end
  ...
  describe 'test an instance of GETJournalEntryItemType' do
    it 'should create an instact of GETJournalEntryItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETJournalEntryItemType)
    end
  end
  describe 'test attribute "accounting_code_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "accounting_code_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "gl_account_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "home_currency_amount"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
