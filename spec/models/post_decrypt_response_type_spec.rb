...
# Unit tests for SwaggerClient::POSTDecryptResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTDecryptResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTDecryptResponseType.new
  end
  ...
  describe 'test an instance of POSTDecryptResponseType' do
    it 'should create an instact of POSTDecryptResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTDecryptResponseType)
    end
  end
  describe 'test attribute "decrypted_signature"' do
    it 'should work' do
