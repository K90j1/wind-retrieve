...
# Unit tests for SwaggerClient::RatePlanChargeTier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatePlanChargeTier' do
  before do
    # run before each test
    @instance = SwaggerClient::RatePlanChargeTier.new
  end
  ...
  describe 'test an instance of RatePlanChargeTier' do
    it 'should create an instact of RatePlanChargeTier' do
      expect(@instance).to be_instance_of(SwaggerClient::RatePlanChargeTier)
    end
  end
  ...
  describe 'test attribute "is_overage_price"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
