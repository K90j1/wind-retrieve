...
# Unit tests for SwaggerClient::ProxyGetPaymentMethodTransactionLog
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetPaymentMethodTransactionLog' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetPaymentMethodTransactionLog.new
  end
  ...
  describe 'test an instance of ProxyGetPaymentMethodTransactionLog' do
    it 'should create an instact of ProxyGetPaymentMethodTransactionLog' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetPaymentMethodTransactionLog)
    end
  end
