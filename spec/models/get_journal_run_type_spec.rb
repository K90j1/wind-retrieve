...
# Unit tests for SwaggerClient::GETJournalRunType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETJournalRunType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETJournalRunType.new
  end
  ...
  describe 'test an instance of GETJournalRunType' do
    it 'should create an instact of GETJournalRunType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETJournalRunType)
    end
  end
  ...
  describe 'test attribute "segmentation_rule_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "target_end_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "target_start_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_journal_entry_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
