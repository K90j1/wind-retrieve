...
# Unit tests for SwaggerClient::POSTAccountResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountResponseType.new
  end
  ...
  describe 'test an instance of POSTAccountResponseType' do
    it 'should create an instact of POSTAccountResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountResponseType)
    end
  end
