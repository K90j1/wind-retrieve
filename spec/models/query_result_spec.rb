...
# Unit tests for SwaggerClient::QueryResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueryResult' do
  before do
    # run before each test
    @instance = SwaggerClient::QueryResult.new
  end
  ...
  describe 'test an instance of QueryResult' do
    it 'should create an instact of QueryResult' do
      expect(@instance).to be_instance_of(SwaggerClient::QueryResult)
    end
  end
  ...
  describe 'test attribute "query_locator"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
