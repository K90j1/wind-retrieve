...
# Unit tests for SwaggerClient::SubscriptionProductFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionProductFeature' do
  before do
    # run before each test
    @instance = SwaggerClient::SubscriptionProductFeature.new
  end
  ...
  describe 'test an instance of SubscriptionProductFeature' do
    it 'should create an instact of SubscriptionProductFeature' do
      expect(@instance).to be_instance_of(SwaggerClient::SubscriptionProductFeature)
    end
  end
