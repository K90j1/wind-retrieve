...
# Unit tests for SwaggerClient::GETAccountingPeriodFileIdsType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountingPeriodFileIdsType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountingPeriodFileIdsType.new
  end
  ...
  describe 'test an instance of GETAccountingPeriodFileIdsType' do
    it 'should create an instact of GETAccountingPeriodFileIdsType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountingPeriodFileIdsType)
    end
  end
  describe 'test attribute "accounts_receivable_account_aging_detail_export_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "accounts_receivable_invoice_aging_detail_export_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ar_roll_forward_detail_export_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "fx_realized_gain_and_loss_detail_export_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "fx_unrealized_gain_and_loss_detail_export_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "revenue_detail_csv_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "revenue_detail_excel_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unprocessed_charges_file_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
