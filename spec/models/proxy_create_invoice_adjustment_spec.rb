...
# Unit tests for SwaggerClient::ProxyCreateInvoiceAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateInvoiceAdjustment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateInvoiceAdjustment.new
  end
  ...
  describe 'test an instance of ProxyCreateInvoiceAdjustment' do
    it 'should create an instact of ProxyCreateInvoiceAdjustment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateInvoiceAdjustment)
    end
  end
  ...
  describe 'test attribute "impact_amount"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
