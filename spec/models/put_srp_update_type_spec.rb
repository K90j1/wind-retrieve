...
# Unit tests for SwaggerClient::PUTSrpUpdateType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSrpUpdateType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSrpUpdateType.new
  end
  ...
  describe 'test an instance of PUTSrpUpdateType' do
    it 'should create an instact of PUTSrpUpdateType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSrpUpdateType)
    end
  end
  describe 'test attribute "charge_update_details"' do
    it 'should work' do
