...
# Unit tests for SwaggerClient::ProxyCreateUnitOfMeasure
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateUnitOfMeasure' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateUnitOfMeasure.new
  end
  ...
  describe 'test an instance of ProxyCreateUnitOfMeasure' do
    it 'should create an instact of ProxyCreateUnitOfMeasure' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateUnitOfMeasure)
    end
  end
  ...
  describe 'test attribute "displayed_as"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rounding_mode"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "uom_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
