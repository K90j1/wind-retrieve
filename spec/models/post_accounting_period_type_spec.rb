...
# Unit tests for SwaggerClient::POSTAccountingPeriodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountingPeriodType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountingPeriodType.new
  end
  ...
  describe 'test an instance of POSTAccountingPeriodType' do
    it 'should create an instact of POSTAccountingPeriodType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountingPeriodType)
    end
  end
