...
# Unit tests for SwaggerClient::PUTSubscriptionPreviewInvoiceItemsType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSubscriptionPreviewInvoiceItemsType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSubscriptionPreviewInvoiceItemsType.new
  end
  ...
  describe 'test an instance of PUTSubscriptionPreviewInvoiceItemsType' do
    it 'should create an instact of PUTSubscriptionPreviewInvoiceItemsType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSubscriptionPreviewInvoiceItemsType)
    end
  end
