...
# Unit tests for SwaggerClient::ProxyCreateProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateProduct' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateProduct.new
  end
  ...
  describe 'test an instance of ProxyCreateProduct' do
    it 'should create an instact of ProxyCreateProduct' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateProduct)
    end
  end
  describe 'test attribute "allow_feature_changes"' do
    it 'should work' do
