...
# Unit tests for SwaggerClient::ProxyGetUnitOfMeasure
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetUnitOfMeasure' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetUnitOfMeasure.new
  end
  ...
  describe 'test an instance of ProxyGetUnitOfMeasure' do
    it 'should create an instact of ProxyGetUnitOfMeasure' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetUnitOfMeasure)
    end
  end
