...
# Unit tests for SwaggerClient::ProxyGetInvoiceItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetInvoiceItem' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetInvoiceItem.new
  end
  ...
  describe 'test an instance of ProxyGetInvoiceItem' do
    it 'should create an instact of ProxyGetInvoiceItem' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetInvoiceItem)
    end
  end
