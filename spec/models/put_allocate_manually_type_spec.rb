...
# Unit tests for SwaggerClient::PUTAllocateManuallyType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTAllocateManuallyType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTAllocateManuallyType.new
  end
  ...
  describe 'test an instance of PUTAllocateManuallyType' do
    it 'should create an instact of PUTAllocateManuallyType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTAllocateManuallyType)
    end
  end
