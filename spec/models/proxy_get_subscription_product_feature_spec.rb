...
# Unit tests for SwaggerClient::ProxyGetSubscriptionProductFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetSubscriptionProductFeature' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetSubscriptionProductFeature.new
  end
  ...
  describe 'test an instance of ProxyGetSubscriptionProductFeature' do
    it 'should create an instact of ProxyGetSubscriptionProductFeature' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetSubscriptionProductFeature)
    end
  end
