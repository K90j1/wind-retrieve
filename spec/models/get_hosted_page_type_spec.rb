...
# Unit tests for SwaggerClient::GetHostedPageType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetHostedPageType' do
  before do
    # run before each test
    @instance = SwaggerClient::GetHostedPageType.new
  end
  ...
  describe 'test an instance of GetHostedPageType' do
    it 'should create an instact of GetHostedPageType' do
      expect(@instance).to be_instance_of(SwaggerClient::GetHostedPageType)
    end
  end
  ...
  describe 'test attribute "page_version"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
