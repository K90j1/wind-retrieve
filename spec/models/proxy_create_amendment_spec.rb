...
# Unit tests for SwaggerClient::ProxyCreateAmendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateAmendment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateAmendment.new
  end
  ...
  describe 'test an instance of ProxyCreateAmendment' do
    it 'should create an instact of ProxyCreateAmendment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateAmendment)
    end
  end
