...
# Unit tests for SwaggerClient::GETChargeRSDetailType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETChargeRSDetailType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETChargeRSDetailType.new
  end
  ...
  describe 'test an instance of GETChargeRSDetailType' do
    it 'should create an instact of GETChargeRSDetailType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETChargeRSDetailType)
    end
  end
