...
# Unit tests for SwaggerClient::GETAccountSummaryInvoiceType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryInvoiceType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryInvoiceType.new
  end
  ...
  describe 'test an instance of GETAccountSummaryInvoiceType' do
    it 'should create an instact of GETAccountSummaryInvoiceType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryInvoiceType)
    end
  end
