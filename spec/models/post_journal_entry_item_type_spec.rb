...
# Unit tests for SwaggerClient::POSTJournalEntryItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTJournalEntryItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTJournalEntryItemType.new
  end
  ...
  describe 'test an instance of POSTJournalEntryItemType' do
    it 'should create an instact of POSTJournalEntryItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTJournalEntryItemType)
    end
  end
