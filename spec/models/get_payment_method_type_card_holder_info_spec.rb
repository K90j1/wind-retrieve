...
# Unit tests for SwaggerClient::GETPaymentMethodTypeCardHolderInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETPaymentMethodTypeCardHolderInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::GETPaymentMethodTypeCardHolderInfo.new
  end
  ...
  describe 'test an instance of GETPaymentMethodTypeCardHolderInfo' do
    it 'should create an instact of GETPaymentMethodTypeCardHolderInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::GETPaymentMethodTypeCardHolderInfo)
    end
  end
