...
# Unit tests for SwaggerClient::ProxyGetExport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetExport' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetExport.new
  end
  ...
  describe 'test an instance of ProxyGetExport' do
    it 'should create an instact of ProxyGetExport' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetExport)
    end
  end
