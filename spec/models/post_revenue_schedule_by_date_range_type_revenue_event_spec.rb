...
# Unit tests for SwaggerClient::POSTRevenueScheduleByDateRangeTypeRevenueEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTRevenueScheduleByDateRangeTypeRevenueEvent' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTRevenueScheduleByDateRangeTypeRevenueEvent.new
  end
  ...
  describe 'test an instance of POSTRevenueScheduleByDateRangeTypeRevenueEvent' do
    it 'should create an instact of POSTRevenueScheduleByDateRangeTypeRevenueEvent' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTRevenueScheduleByDateRangeTypeRevenueEvent)
    end
  end
