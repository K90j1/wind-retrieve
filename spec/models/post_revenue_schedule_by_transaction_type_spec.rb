...
# Unit tests for SwaggerClient::POSTRevenueScheduleByTransactionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTRevenueScheduleByTransactionType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTRevenueScheduleByTransactionType.new
  end
  ...
  describe 'test an instance of POSTRevenueScheduleByTransactionType' do
    it 'should create an instact of POSTRevenueScheduleByTransactionType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTRevenueScheduleByTransactionType)
    end
  end
