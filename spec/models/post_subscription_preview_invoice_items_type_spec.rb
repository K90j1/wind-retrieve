...
# Unit tests for SwaggerClient::POSTSubscriptionPreviewInvoiceItemsType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTSubscriptionPreviewInvoiceItemsType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTSubscriptionPreviewInvoiceItemsType.new
  end
  ...
  describe 'test an instance of POSTSubscriptionPreviewInvoiceItemsType' do
    it 'should create an instact of POSTSubscriptionPreviewInvoiceItemsType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTSubscriptionPreviewInvoiceItemsType)
    end
  end
