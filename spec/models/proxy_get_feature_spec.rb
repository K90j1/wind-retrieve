...
# Unit tests for SwaggerClient::ProxyGetFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetFeature' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetFeature.new
  end
  ...
  describe 'test an instance of ProxyGetFeature' do
    it 'should create an instact of ProxyGetFeature' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetFeature)
    end
  end
