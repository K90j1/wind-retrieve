...
# Unit tests for SwaggerClient::GETSubscriptionRatePlanType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETSubscriptionRatePlanType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETSubscriptionRatePlanType.new
  end
  ...
  describe 'test an instance of GETSubscriptionRatePlanType' do
    it 'should create an instact of GETSubscriptionRatePlanType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETSubscriptionRatePlanType)
    end
  end
  ...
  describe 'test attribute "last_change_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "rate_plan_charges"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rate_plan_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "subscription_product_features"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
