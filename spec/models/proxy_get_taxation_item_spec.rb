...
# Unit tests for SwaggerClient::ProxyGetTaxationItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetTaxationItem' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetTaxationItem.new
  end
  ...
  describe 'test an instance of ProxyGetTaxationItem' do
    it 'should create an instact of ProxyGetTaxationItem' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetTaxationItem)
    end
  end
