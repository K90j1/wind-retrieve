...
# Unit tests for SwaggerClient::ProxyGetProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetProduct' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetProduct.new
  end
  ...
  describe 'test an instance of ProxyGetProduct' do
    it 'should create an instact of ProxyGetProduct' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetProduct)
    end
  end
