...
# Unit tests for SwaggerClient::GETAttachmentResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAttachmentResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAttachmentResponseType.new
  end
  ...
  describe 'test an instance of GETAttachmentResponseType' do
    it 'should create an instact of GETAttachmentResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAttachmentResponseType)
    end
  end
