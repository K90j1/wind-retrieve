...
# Unit tests for SwaggerClient::GETAttachmentResponseWithoutSuccessType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAttachmentResponseWithoutSuccessType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAttachmentResponseWithoutSuccessType.new
  end
  ...
  describe 'test an instance of GETAttachmentResponseWithoutSuccessType' do
    it 'should create an instact of GETAttachmentResponseWithoutSuccessType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAttachmentResponseWithoutSuccessType)
    end
  end
