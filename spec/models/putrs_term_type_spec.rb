...
# Unit tests for SwaggerClient::PUTRSTermType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTRSTermType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTRSTermType.new
  end
  ...
  describe 'test an instance of PUTRSTermType' do
    it 'should create an instact of PUTRSTermType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTRSTermType)
    end
  end
