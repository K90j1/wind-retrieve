...
# Unit tests for SwaggerClient::PUTSubscriptionSuspendResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSubscriptionSuspendResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSubscriptionSuspendResponseType.new
  end
  ...
  describe 'test an instance of PUTSubscriptionSuspendResponseType' do
    it 'should create an instact of PUTSubscriptionSuspendResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSubscriptionSuspendResponseType)
    end
  end
