...
# Unit tests for SwaggerClient::GETAccountingPeriodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountingPeriodType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountingPeriodType.new
  end
  ...
  describe 'test an instance of GETAccountingPeriodType' do
    it 'should create an instact of GETAccountingPeriodType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountingPeriodType)
    end
  end
