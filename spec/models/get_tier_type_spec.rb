...
# Unit tests for SwaggerClient::GETTierType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETTierType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETTierType.new
  end
  ...
  describe 'test an instance of GETTierType' do
    it 'should create an instact of GETTierType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETTierType)
    end
  end
