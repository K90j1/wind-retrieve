...
# Unit tests for SwaggerClient::ProxyGetRefundInvoicePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRefundInvoicePayment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRefundInvoicePayment.new
  end
  ...
  describe 'test an instance of ProxyGetRefundInvoicePayment' do
    it 'should create an instact of ProxyGetRefundInvoicePayment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRefundInvoicePayment)
    end
  end
