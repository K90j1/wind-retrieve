...
# Unit tests for SwaggerClient::GETRsRevenueItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRsRevenueItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRsRevenueItemType.new
  end
  ...
  describe 'test an instance of GETRsRevenueItemType' do
    it 'should create an instact of GETRsRevenueItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRsRevenueItemType)
    end
  end
  describe 'test attribute "accounting_period_end_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "accounting_period_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "accounting_period_start_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "is_accounting_period_closed"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
