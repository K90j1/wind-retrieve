...
# Unit tests for SwaggerClient::ProxyGetRatePlanChargeTier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRatePlanChargeTier' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRatePlanChargeTier.new
  end
  ...
  describe 'test an instance of ProxyGetRatePlanChargeTier' do
    it 'should create an instact of ProxyGetRatePlanChargeTier' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRatePlanChargeTier)
    end
  end
