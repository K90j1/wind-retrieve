...
# Unit tests for SwaggerClient::POSTSubscriptionCancellationType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTSubscriptionCancellationType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTSubscriptionCancellationType.new
  end
  ...
  describe 'test an instance of POSTSubscriptionCancellationType' do
    it 'should create an instact of POSTSubscriptionCancellationType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTSubscriptionCancellationType)
    end
  end
  describe 'test attribute "opportunity_close_date_qt"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "opportunity_name_qt"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "quote_business_type_qt"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "quote_number_qt"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "quote_type_qt"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "cancellation_effective_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
