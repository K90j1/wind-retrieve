...
# Unit tests for SwaggerClient::ProxyGetProductFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetProductFeature' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetProductFeature.new
  end
  ...
  describe 'test an instance of ProxyGetProductFeature' do
    it 'should create an instact of ProxyGetProductFeature' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetProductFeature)
    end
  end
