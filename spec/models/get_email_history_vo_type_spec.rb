...
# Unit tests for SwaggerClient::GETEmailHistoryVOType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETEmailHistoryVOType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETEmailHistoryVOType.new
  end
  ...
  describe 'test an instance of GETEmailHistoryVOType' do
    it 'should create an instact of GETEmailHistoryVOType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETEmailHistoryVOType)
    end
  end
