...
# Unit tests for SwaggerClient::PUTSrpAddType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSrpAddType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSrpAddType.new
  end
  ...
  describe 'test an instance of PUTSrpAddType' do
    it 'should create an instact of PUTSrpAddType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSrpAddType)
    end
  end
  describe 'test attribute "charge_overrides"' do
    it 'should work' do
