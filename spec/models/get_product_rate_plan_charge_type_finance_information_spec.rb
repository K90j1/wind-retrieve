...
# Unit tests for SwaggerClient::GETProductRatePlanChargeTypeFinanceInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETProductRatePlanChargeTypeFinanceInformation' do
  before do
    # run before each test
    @instance = SwaggerClient::GETProductRatePlanChargeTypeFinanceInformation.new
  end
  ...
  describe 'test an instance of GETProductRatePlanChargeTypeFinanceInformation' do
    it 'should create an instact of GETProductRatePlanChargeTypeFinanceInformation' do
      expect(@instance).to be_instance_of(SwaggerClient::GETProductRatePlanChargeTypeFinanceInformation)
    end
  end
