...
# Unit tests for SwaggerClient::POSTAccountTypeTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountTypeTaxInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountTypeTaxInfo.new
  end
  ...
  describe 'test an instance of POSTAccountTypeTaxInfo' do
    it 'should create an instact of POSTAccountTypeTaxInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountTypeTaxInfo)
    end
  end
