...
# Unit tests for SwaggerClient::POSTTierType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTTierType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTTierType.new
  end
  ...
  describe 'test an instance of POSTTierType' do
    it 'should create an instact of POSTTierType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTTierType)
    end
  end
