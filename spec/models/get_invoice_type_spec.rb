...
# Unit tests for SwaggerClient::GETInvoiceType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETInvoiceType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETInvoiceType.new
  end
  ...
  describe 'test an instance of GETInvoiceType' do
    it 'should create an instact of GETInvoiceType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETInvoiceType)
    end
  end
  ...
  describe 'test attribute "invoice_files"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
