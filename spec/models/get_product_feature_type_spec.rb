...
# Unit tests for SwaggerClient::GetProductFeatureType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetProductFeatureType' do
  before do
    # run before each test
    @instance = SwaggerClient::GetProductFeatureType.new
  end
  ...
  describe 'test an instance of GetProductFeatureType' do
    it 'should create an instact of GetProductFeatureType' do
      expect(@instance).to be_instance_of(SwaggerClient::GetProductFeatureType)
    end
  end
