...
# Unit tests for SwaggerClient::POSTAccountTypeCreditCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountTypeCreditCard' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountTypeCreditCard.new
  end
  ...
  describe 'test an instance of POSTAccountTypeCreditCard' do
    it 'should create an instact of POSTAccountTypeCreditCard' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountTypeCreditCard)
    end
  end
  describe 'test attribute "card_holder_info"' do
    it 'should work' do
