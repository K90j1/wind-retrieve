...
# Unit tests for SwaggerClient::ExternalPaymentOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExternalPaymentOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::ExternalPaymentOptions.new
  end
  ...
  describe 'test an instance of ExternalPaymentOptions' do
    it 'should create an instact of ExternalPaymentOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::ExternalPaymentOptions)
    end
  end
