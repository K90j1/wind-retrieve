...
# Unit tests for SwaggerClient::ProxyCreateInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateInvoice' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateInvoice.new
  end
  ...
  describe 'test an instance of ProxyCreateInvoice' do
    it 'should create an instact of ProxyCreateInvoice' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateInvoice)
    end
  end
