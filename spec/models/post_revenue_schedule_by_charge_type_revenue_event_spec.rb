...
# Unit tests for SwaggerClient::POSTRevenueScheduleByChargeTypeRevenueEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTRevenueScheduleByChargeTypeRevenueEvent' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTRevenueScheduleByChargeTypeRevenueEvent.new
  end
  ...
  describe 'test an instance of POSTRevenueScheduleByChargeTypeRevenueEvent' do
    it 'should create an instact of POSTRevenueScheduleByChargeTypeRevenueEvent' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTRevenueScheduleByChargeTypeRevenueEvent)
    end
  end
