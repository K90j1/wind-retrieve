...
# Unit tests for SwaggerClient::PUTRenewSubscriptionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTRenewSubscriptionType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTRenewSubscriptionType.new
  end
  ...
  describe 'test an instance of PUTRenewSubscriptionType' do
    it 'should create an instact of PUTRenewSubscriptionType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTRenewSubscriptionType)
    end
  end
