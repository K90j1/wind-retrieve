...
# Unit tests for SwaggerClient::POSTSubscriptionPreviewTypePreviewAccountInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTSubscriptionPreviewTypePreviewAccountInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTSubscriptionPreviewTypePreviewAccountInfo.new
  end
  ...
  describe 'test an instance of POSTSubscriptionPreviewTypePreviewAccountInfo' do
    it 'should create an instact of POSTSubscriptionPreviewTypePreviewAccountInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTSubscriptionPreviewTypePreviewAccountInfo)
    end
  end
