...
# Unit tests for SwaggerClient::ProxyGetProductRatePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetProductRatePlan' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetProductRatePlan.new
  end
  ...
  describe 'test an instance of ProxyGetProductRatePlan' do
    it 'should create an instact of ProxyGetProductRatePlan' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetProductRatePlan)
    end
  end
