...
# Unit tests for SwaggerClient::GETAccountTypeBasicInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountTypeBasicInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountTypeBasicInfo.new
  end
  ...
  describe 'test an instance of GETAccountTypeBasicInfo' do
    it 'should create an instact of GETAccountTypeBasicInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountTypeBasicInfo)
    end
  end
