...
# Unit tests for SwaggerClient::PUTAccountingPeriodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTAccountingPeriodType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTAccountingPeriodType.new
  end
  ...
  describe 'test an instance of PUTAccountingPeriodType' do
    it 'should create an instact of PUTAccountingPeriodType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTAccountingPeriodType)
    end
  end
