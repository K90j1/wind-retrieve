...
# Unit tests for SwaggerClient::GETAccountSummaryTypeSoldToContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryTypeSoldToContact' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryTypeSoldToContact.new
  end
  ...
  describe 'test an instance of GETAccountSummaryTypeSoldToContact' do
    it 'should create an instact of GETAccountSummaryTypeSoldToContact' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryTypeSoldToContact)
    end
  end
