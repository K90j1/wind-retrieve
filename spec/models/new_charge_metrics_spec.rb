...
# Unit tests for SwaggerClient::NewChargeMetrics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewChargeMetrics' do
  before do
    # run before each test
    @instance = SwaggerClient::NewChargeMetrics.new
  end
  ...
  describe 'test an instance of NewChargeMetrics' do
    it 'should create an instact of NewChargeMetrics' do
      expect(@instance).to be_instance_of(SwaggerClient::NewChargeMetrics)
    end
  end
  ...
  describe 'test attribute "original_rate_plan_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
