...
# Unit tests for SwaggerClient::ProxyCreateSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateSubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateSubscription.new
  end
  ...
  describe 'test an instance of ProxyCreateSubscription' do
    it 'should create an instact of ProxyCreateSubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateSubscription)
    end
  end
