...
# Unit tests for SwaggerClient::ProxyGetRefundTransactionLog
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRefundTransactionLog' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRefundTransactionLog.new
  end
  ...
  describe 'test an instance of ProxyGetRefundTransactionLog' do
    it 'should create an instact of ProxyGetRefundTransactionLog' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRefundTransactionLog)
    end
  end
