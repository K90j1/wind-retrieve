...
# Unit tests for SwaggerClient::POSTAccountTypeCreditCardCardHolderInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountTypeCreditCardCardHolderInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountTypeCreditCardCardHolderInfo.new
  end
  ...
  describe 'test an instance of POSTAccountTypeCreditCardCardHolderInfo' do
    it 'should create an instact of POSTAccountTypeCreditCardCardHolderInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountTypeCreditCardCardHolderInfo)
    end
  end
