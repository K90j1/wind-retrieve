...
# Unit tests for SwaggerClient::PUTAccountingCodeType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTAccountingCodeType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTAccountingCodeType.new
  end
  ...
  describe 'test an instance of PUTAccountingCodeType' do
    it 'should create an instact of PUTAccountingCodeType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTAccountingCodeType)
    end
  end
