...
# Unit tests for SwaggerClient::POSTPaymentMethodTypeCardHolderInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTPaymentMethodTypeCardHolderInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTPaymentMethodTypeCardHolderInfo.new
  end
  ...
  describe 'test an instance of POSTPaymentMethodTypeCardHolderInfo' do
    it 'should create an instact of POSTPaymentMethodTypeCardHolderInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTPaymentMethodTypeCardHolderInfo)
    end
  end
