...
# Unit tests for SwaggerClient::GETSubscriptionProductFeatureType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETSubscriptionProductFeatureType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETSubscriptionProductFeatureType.new
  end
  ...
  describe 'test an instance of GETSubscriptionProductFeatureType' do
    it 'should create an instact of GETSubscriptionProductFeatureType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETSubscriptionProductFeatureType)
    end
  end
