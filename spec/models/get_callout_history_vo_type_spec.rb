...
# Unit tests for SwaggerClient::GETCalloutHistoryVOType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETCalloutHistoryVOType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETCalloutHistoryVOType.new
  end
  ...
  describe 'test an instance of GETCalloutHistoryVOType' do
    it 'should create an instact of GETCalloutHistoryVOType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETCalloutHistoryVOType)
    end
  end
  describe 'test attribute "attempted_num"' do
    it 'should work' do
