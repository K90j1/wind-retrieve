...
# Unit tests for SwaggerClient::GETRSDetailWithoutSuccessType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRSDetailWithoutSuccessType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRSDetailWithoutSuccessType.new
  end
  ...
  describe 'test an instance of GETRSDetailWithoutSuccessType' do
    it 'should create an instact of GETRSDetailWithoutSuccessType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRSDetailWithoutSuccessType)
    end
  end
  ...
  describe 'test attribute "linked_transaction_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "linked_transaction_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "recognition_rule_name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "recognized_revenue"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "undistributed_unrecognized_revenue"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unrecognized_revenue"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
