...
# Unit tests for SwaggerClient::ProxyModifyPayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyPayment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyPayment.new
  end
  ...
  describe 'test an instance of ProxyModifyPayment' do
    it 'should create an instact of ProxyModifyPayment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyPayment)
    end
  end
