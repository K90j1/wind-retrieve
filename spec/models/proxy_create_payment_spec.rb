...
# Unit tests for SwaggerClient::ProxyCreatePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreatePayment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreatePayment.new
  end
  ...
  describe 'test an instance of ProxyCreatePayment' do
    it 'should create an instact of ProxyCreatePayment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreatePayment)
    end
  end
