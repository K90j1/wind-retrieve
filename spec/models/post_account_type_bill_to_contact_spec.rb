...
# Unit tests for SwaggerClient::POSTAccountTypeBillToContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountTypeBillToContact' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountTypeBillToContact.new
  end
  ...
  describe 'test an instance of POSTAccountTypeBillToContact' do
    it 'should create an instact of POSTAccountTypeBillToContact' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountTypeBillToContact)
    end
  end
  ...
  describe 'test attribute "other_phone_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
