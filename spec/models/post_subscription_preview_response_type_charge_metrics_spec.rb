...
# Unit tests for SwaggerClient::POSTSubscriptionPreviewResponseTypeChargeMetrics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTSubscriptionPreviewResponseTypeChargeMetrics' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTSubscriptionPreviewResponseTypeChargeMetrics.new
  end
  ...
  describe 'test an instance of POSTSubscriptionPreviewResponseTypeChargeMetrics' do
    it 'should create an instact of POSTSubscriptionPreviewResponseTypeChargeMetrics' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTSubscriptionPreviewResponseTypeChargeMetrics)
    end
  end
  describe 'test attribute "dmrr"' do
    it 'should work' do
  ...
  describe 'test attribute "origin_rate_plan_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
