...
# Unit tests for SwaggerClient::ProxyCreateExport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateExport' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateExport.new
  end
  ...
  describe 'test an instance of ProxyCreateExport' do
    it 'should create an instact of ProxyCreateExport' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateExport)
    end
  end
  describe 'test attribute "convert_to_currencies"' do
    it 'should work' do
