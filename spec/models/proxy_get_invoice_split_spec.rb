...
# Unit tests for SwaggerClient::ProxyGetInvoiceSplit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetInvoiceSplit' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetInvoiceSplit.new
  end
  ...
  describe 'test an instance of ProxyGetInvoiceSplit' do
    it 'should create an instact of ProxyGetInvoiceSplit' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetInvoiceSplit)
    end
  end
