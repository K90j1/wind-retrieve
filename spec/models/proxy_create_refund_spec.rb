...
# Unit tests for SwaggerClient::ProxyCreateRefund
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateRefund' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateRefund.new
  end
  ...
  describe 'test an instance of ProxyCreateRefund' do
    it 'should create an instact of ProxyCreateRefund' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateRefund)
    end
  end
