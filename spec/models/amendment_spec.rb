...
# Unit tests for SwaggerClient::Amendment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Amendment' do
  before do
    # run before each test
    @instance = SwaggerClient::Amendment.new
  end
  ...
  describe 'test an instance of Amendment' do
    it 'should create an instact of Amendment' do
      expect(@instance).to be_instance_of(SwaggerClient::Amendment)
    end
  end
  ...
  describe 'test attribute "rate_plan_data"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
