...
# Unit tests for SwaggerClient::POSTRevenueScheduleByDateRangeType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTRevenueScheduleByDateRangeType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTRevenueScheduleByDateRangeType.new
  end
  ...
  describe 'test an instance of POSTRevenueScheduleByDateRangeType' do
    it 'should create an instact of POSTRevenueScheduleByDateRangeType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTRevenueScheduleByDateRangeType)
    end
  end
  ...
  describe 'test attribute "recognition_end"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "recognition_start"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
