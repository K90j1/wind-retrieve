...
# Unit tests for SwaggerClient::ProxyGetImport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetImport' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetImport.new
  end
  ...
  describe 'test an instance of ProxyGetImport' do
    it 'should create an instact of ProxyGetImport' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetImport)
    end
  end
  ...
  describe 'test attribute "original_resource_url"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "result_resource_url"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
