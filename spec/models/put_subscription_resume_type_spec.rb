...
# Unit tests for SwaggerClient::PUTSubscriptionResumeType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSubscriptionResumeType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSubscriptionResumeType.new
  end
  ...
  describe 'test an instance of PUTSubscriptionResumeType' do
    it 'should create an instact of PUTSubscriptionResumeType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSubscriptionResumeType)
    end
  end
