...
# Unit tests for SwaggerClient::PUTSrpRemoveType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSrpRemoveType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSrpRemoveType.new
  end
  ...
  describe 'test an instance of PUTSrpRemoveType' do
    it 'should create an instact of PUTSrpRemoveType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSrpRemoveType)
    end
  end
