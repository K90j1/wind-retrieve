...
# Unit tests for SwaggerClient::GETAccountType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountType.new
  end
  ...
  describe 'test an instance of GETAccountType' do
    it 'should create an instact of GETAccountType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountType)
    end
  end
  ...
  describe 'test attribute "billing_and_payment"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
