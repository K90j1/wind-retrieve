...
# Unit tests for SwaggerClient::POSTRSASignatureResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTRSASignatureResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTRSASignatureResponseType.new
  end
  ...
  describe 'test an instance of POSTRSASignatureResponseType' do
    it 'should create an instact of POSTRSASignatureResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTRSASignatureResponseType)
    end
  end
