...
# Unit tests for SwaggerClient::POSTHMACSignatureType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTHMACSignatureType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTHMACSignatureType.new
  end
  ...
  describe 'test an instance of POSTHMACSignatureType' do
    it 'should create an instact of POSTHMACSignatureType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTHMACSignatureType)
    end
  end
