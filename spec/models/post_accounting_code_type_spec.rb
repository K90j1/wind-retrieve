...
# Unit tests for SwaggerClient::POSTAccountingCodeType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTAccountingCodeType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTAccountingCodeType.new
  end
  ...
  describe 'test an instance of POSTAccountingCodeType' do
    it 'should create an instact of POSTAccountingCodeType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTAccountingCodeType)
    end
  end
