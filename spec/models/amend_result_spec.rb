...
# Unit tests for SwaggerClient::AmendResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmendResult' do
  before do
    # run before each test
    @instance = SwaggerClient::AmendResult.new
  end
  ...
  describe 'test an instance of AmendResult' do
    it 'should create an instact of AmendResult' do
      expect(@instance).to be_instance_of(SwaggerClient::AmendResult)
    end
  end
  describe 'test attribute "amendment_ids"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "charge_metrics_data"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "invoice_datas"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payment_transaction_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
