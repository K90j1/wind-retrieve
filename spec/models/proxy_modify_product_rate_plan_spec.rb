...
# Unit tests for SwaggerClient::ProxyModifyProductRatePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyProductRatePlan' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyProductRatePlan.new
  end
  ...
  describe 'test an instance of ProxyModifyProductRatePlan' do
    it 'should create an instact of ProxyModifyProductRatePlan' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyProductRatePlan)
    end
  end
