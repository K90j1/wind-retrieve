...
# Unit tests for SwaggerClient::ProxyModifyUnitOfMeasure
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyUnitOfMeasure' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyUnitOfMeasure.new
  end
  ...
  describe 'test an instance of ProxyModifyUnitOfMeasure' do
    it 'should create an instact of ProxyModifyUnitOfMeasure' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyUnitOfMeasure)
    end
  end
