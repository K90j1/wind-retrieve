...
# Unit tests for SwaggerClient::GETAccountTypeMetrics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountTypeMetrics' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountTypeMetrics.new
  end
  ...
  describe 'test an instance of GETAccountTypeMetrics' do
    it 'should create an instact of GETAccountTypeMetrics' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountTypeMetrics)
    end
  end
