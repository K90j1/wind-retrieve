...
# Unit tests for SwaggerClient::PUTScUpdateType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTScUpdateType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTScUpdateType.new
  end
  ...
  describe 'test an instance of PUTScUpdateType' do
    it 'should create an instact of PUTScUpdateType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTScUpdateType)
    end
  end
