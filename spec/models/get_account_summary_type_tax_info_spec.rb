...
# Unit tests for SwaggerClient::GETAccountSummaryTypeTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryTypeTaxInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryTypeTaxInfo.new
  end
  ...
  describe 'test an instance of GETAccountSummaryTypeTaxInfo' do
    it 'should create an instact of GETAccountSummaryTypeTaxInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryTypeTaxInfo)
    end
  end
  ...
  describe 'test attribute "exempt_certificate_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_certificate_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_description"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_effective_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_expiration_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_issuing_jurisdiction"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "exempt_status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
