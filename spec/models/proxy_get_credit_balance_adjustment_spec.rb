...
# Unit tests for SwaggerClient::ProxyGetCreditBalanceAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetCreditBalanceAdjustment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetCreditBalanceAdjustment.new
  end
  ...
  describe 'test an instance of ProxyGetCreditBalanceAdjustment' do
    it 'should create an instact of ProxyGetCreditBalanceAdjustment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetCreditBalanceAdjustment)
    end
  end
  ...
  describe 'test attribute "integration_id__ns"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "integration_status__ns"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "source_transaction_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "source_transaction_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sync_date__ns"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
