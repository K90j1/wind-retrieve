...
# Unit tests for SwaggerClient::GETAccountingCodeItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountingCodeItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountingCodeItemType.new
  end
  ...
  describe 'test an instance of GETAccountingCodeItemType' do
    it 'should create an instact of GETAccountingCodeItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountingCodeItemType)
    end
  end
