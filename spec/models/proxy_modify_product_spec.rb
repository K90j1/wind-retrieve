...
# Unit tests for SwaggerClient::ProxyModifyProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyProduct' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyProduct.new
  end
  ...
  describe 'test an instance of ProxyModifyProduct' do
    it 'should create an instact of ProxyModifyProduct' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyProduct)
    end
  end
