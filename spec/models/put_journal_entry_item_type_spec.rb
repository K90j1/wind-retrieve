...
# Unit tests for SwaggerClient::PUTJournalEntryItemType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTJournalEntryItemType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTJournalEntryItemType.new
  end
  ...
  describe 'test an instance of PUTJournalEntryItemType' do
    it 'should create an instact of PUTJournalEntryItemType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTJournalEntryItemType)
    end
  end
