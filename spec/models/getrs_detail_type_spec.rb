...
# Unit tests for SwaggerClient::GETRSDetailType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETRSDetailType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETRSDetailType.new
  end
  ...
  describe 'test an instance of GETRSDetailType' do
    it 'should create an instact of GETRSDetailType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETRSDetailType)
    end
  end
