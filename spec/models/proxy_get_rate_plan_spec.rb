...
# Unit tests for SwaggerClient::ProxyGetRatePlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetRatePlan' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetRatePlan.new
  end
  ...
  describe 'test an instance of ProxyGetRatePlan' do
    it 'should create an instact of ProxyGetRatePlan' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetRatePlan)
    end
  end
