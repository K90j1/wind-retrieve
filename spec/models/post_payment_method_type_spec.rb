...
# Unit tests for SwaggerClient::POSTPaymentMethodType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTPaymentMethodType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTPaymentMethodType.new
  end
  ...
  describe 'test an instance of POSTPaymentMethodType' do
    it 'should create an instact of POSTPaymentMethodType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTPaymentMethodType)
    end
  end
