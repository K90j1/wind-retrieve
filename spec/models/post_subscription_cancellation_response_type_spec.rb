...
# Unit tests for SwaggerClient::POSTSubscriptionCancellationResponseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'POSTSubscriptionCancellationResponseType' do
  before do
    # run before each test
    @instance = SwaggerClient::POSTSubscriptionCancellationResponseType.new
  end
  ...
  describe 'test an instance of POSTSubscriptionCancellationResponseType' do
    it 'should create an instact of POSTSubscriptionCancellationResponseType' do
      expect(@instance).to be_instance_of(SwaggerClient::POSTSubscriptionCancellationResponseType)
    end
  end
