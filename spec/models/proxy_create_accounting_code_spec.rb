...
# Unit tests for SwaggerClient::ProxyCreateAccountingCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyCreateAccountingCode' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyCreateAccountingCode.new
  end
  ...
  describe 'test an instance of ProxyCreateAccountingCode' do
    it 'should create an instact of ProxyCreateAccountingCode' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyCreateAccountingCode)
    end
  end
