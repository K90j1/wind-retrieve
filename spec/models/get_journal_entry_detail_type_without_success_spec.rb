...
# Unit tests for SwaggerClient::GETJournalEntryDetailTypeWithoutSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETJournalEntryDetailTypeWithoutSuccess' do
  before do
    # run before each test
    @instance = SwaggerClient::GETJournalEntryDetailTypeWithoutSuccess.new
  end
  ...
  describe 'test an instance of GETJournalEntryDetailTypeWithoutSuccess' do
    it 'should create an instact of GETJournalEntryDetailTypeWithoutSuccess' do
      expect(@instance).to be_instance_of(SwaggerClient::GETJournalEntryDetailTypeWithoutSuccess)
    end
  end
  ...
  describe 'test attribute "aggregate_currency"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "home_currency"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "journal_entry_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "journal_entry_items"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "transfer_date_time"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "transferred_by"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
