...
# Unit tests for SwaggerClient::ProxyGetInvoicePayment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetInvoicePayment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetInvoicePayment.new
  end
  ...
  describe 'test an instance of ProxyGetInvoicePayment' do
    it 'should create an instact of ProxyGetInvoicePayment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetInvoicePayment)
    end
  end
