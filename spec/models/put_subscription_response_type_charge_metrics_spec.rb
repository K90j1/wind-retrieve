...
# Unit tests for SwaggerClient::PUTSubscriptionResponseTypeChargeMetrics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTSubscriptionResponseTypeChargeMetrics' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTSubscriptionResponseTypeChargeMetrics.new
  end
  ...
  describe 'test an instance of PUTSubscriptionResponseTypeChargeMetrics' do
    it 'should create an instact of PUTSubscriptionResponseTypeChargeMetrics' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTSubscriptionResponseTypeChargeMetrics)
    end
  end
