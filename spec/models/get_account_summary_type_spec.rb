...
# Unit tests for SwaggerClient::GETAccountSummaryType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountSummaryType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountSummaryType.new
  end
  ...
  describe 'test an instance of GETAccountSummaryType' do
    it 'should create an instact of GETAccountSummaryType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountSummaryType)
    end
  end
