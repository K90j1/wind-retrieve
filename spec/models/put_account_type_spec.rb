...
# Unit tests for SwaggerClient::PUTAccountType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PUTAccountType' do
  before do
    # run before each test
    @instance = SwaggerClient::PUTAccountType.new
  end
  ...
  describe 'test an instance of PUTAccountType' do
    it 'should create an instact of PUTAccountType' do
      expect(@instance).to be_instance_of(SwaggerClient::PUTAccountType)
    end
  end
