...
# Unit tests for SwaggerClient::GETUsageType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETUsageType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETUsageType.new
  end
  ...
  describe 'test an instance of GETUsageType' do
    it 'should create an instact of GETUsageType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETUsageType)
    end
  end
