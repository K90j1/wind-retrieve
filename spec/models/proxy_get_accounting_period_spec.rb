...
# Unit tests for SwaggerClient::ProxyGetAccountingPeriod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetAccountingPeriod' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetAccountingPeriod.new
  end
  ...
  describe 'test an instance of ProxyGetAccountingPeriod' do
    it 'should create an instact of ProxyGetAccountingPeriod' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetAccountingPeriod)
    end
  end
