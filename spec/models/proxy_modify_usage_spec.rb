...
# Unit tests for SwaggerClient::ProxyModifyUsage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyModifyUsage' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyModifyUsage.new
  end
  ...
  describe 'test an instance of ProxyModifyUsage' do
    it 'should create an instact of ProxyModifyUsage' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyModifyUsage)
    end
  end
