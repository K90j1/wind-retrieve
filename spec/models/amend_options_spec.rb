...
# Unit tests for SwaggerClient::AmendOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmendOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::AmendOptions.new
  end
  ...
  describe 'test an instance of AmendOptions' do
    it 'should create an instact of AmendOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::AmendOptions)
    end
  end
  ...
  describe 'test attribute "invoice_processing_options"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
