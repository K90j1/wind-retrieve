...
# Unit tests for SwaggerClient::ProxyGetInvoiceAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProxyGetInvoiceAdjustment' do
  before do
    # run before each test
    @instance = SwaggerClient::ProxyGetInvoiceAdjustment.new
  end
  ...
  describe 'test an instance of ProxyGetInvoiceAdjustment' do
    it 'should create an instact of ProxyGetInvoiceAdjustment' do
      expect(@instance).to be_instance_of(SwaggerClient::ProxyGetInvoiceAdjustment)
    end
  end
