...
# Unit tests for SwaggerClient::GETAccountingCodeItemWithoutSuccessType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GETAccountingCodeItemWithoutSuccessType' do
  before do
    # run before each test
    @instance = SwaggerClient::GETAccountingCodeItemWithoutSuccessType.new
  end
  ...
  describe 'test an instance of GETAccountingCodeItemWithoutSuccessType' do
    it 'should create an instact of GETAccountingCodeItemWithoutSuccessType' do
      expect(@instance).to be_instance_of(SwaggerClient::GETAccountingCodeItemWithoutSuccessType)
    end
  end
