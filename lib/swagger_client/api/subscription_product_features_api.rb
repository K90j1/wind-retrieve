...
module SwaggerClient
  class SubscriptionProductFeaturesApi
    ...
    def proxy_delete_subscription_product_feature(id, opts = {})
      data, _status_code, _headers = proxy_delete_subscription_product_feature_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_subscription_product_feature_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionProductFeaturesApi.proxy_delete_subscription_product_feature ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling SubscriptionProductFeaturesApi.proxy_delete_subscription_product_feature" if id.nil?
      # resource path
      local_var_path = "/object/subscription-product-feature/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionProductFeaturesApi#proxy_delete_subscription_product_feature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_subscription_product_feature(id, opts = {})
      data, _status_code, _headers = proxy_get_subscription_product_feature_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetSubscriptionProductFeature, Fixnum, Hash)>] ProxyGetSubscriptionProductFeature data, response status code and response headers
    def proxy_get_subscription_product_feature_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SubscriptionProductFeaturesApi.proxy_get_subscription_product_feature ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling SubscriptionProductFeaturesApi.proxy_get_subscription_product_feature" if id.nil?
      # resource path
      local_var_path = "/object/subscription-product-feature/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetSubscriptionProductFeature')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SubscriptionProductFeaturesApi#proxy_get_subscription_product_feature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
