...
module SwaggerClient
  class ActionsApi
    ...
    def proxy_action_pos_tamend(amend_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tamend_with_http_info(amend_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tamend_with_http_info(amend_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tamend ..."
      end
      # verify the required parameter 'amend_request' is set
      fail ArgumentError, "Missing the required parameter 'amend_request' when calling ActionsApi.proxy_action_pos_tamend" if amend_request.nil?
      # resource path
      local_var_path = "/action/amend".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tamend\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_action_pos_tcreate(create_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tcreate_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tcreate_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tcreate ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling ActionsApi.proxy_action_pos_tcreate" if create_request.nil?
      # resource path
      local_var_path = "/action/create".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tcreate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tdelete(delete_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tdelete_with_http_info(delete_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tdelete_with_http_info(delete_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tdelete ..."
      end
      # verify the required parameter 'delete_request' is set
      fail ArgumentError, "Missing the required parameter 'delete_request' when calling ActionsApi.proxy_action_pos_tdelete" if delete_request.nil?
      # resource path
      local_var_path = "/action/delete".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tdelete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_texecute(execute_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_texecute_with_http_info(execute_request, opts)
      return data
    end
    ...
    def proxy_action_pos_texecute_with_http_info(execute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_texecute ..."
      end
      # verify the required parameter 'execute_request' is set
      fail ArgumentError, "Missing the required parameter 'execute_request' when calling ActionsApi.proxy_action_pos_texecute" if execute_request.nil?
      # resource path
      local_var_path = "/action/execute".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_texecute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tgenerate(generate_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tgenerate_with_http_info(generate_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tgenerate_with_http_info(generate_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tgenerate ..."
      end
      # verify the required parameter 'generate_request' is set
      fail ArgumentError, "Missing the required parameter 'generate_request' when calling ActionsApi.proxy_action_pos_tgenerate" if generate_request.nil?
      # resource path
      local_var_path = "/action/generate".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tgenerate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tquery(query_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tquery_with_http_info(query_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tquery_with_http_info(query_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tquery ..."
      end
      # verify the required parameter 'query_request' is set
      fail ArgumentError, "Missing the required parameter 'query_request' when calling ActionsApi.proxy_action_pos_tquery" if query_request.nil?
      # resource path
      local_var_path = "/action/query".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tquery\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tquery_more(query_more_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tquery_more_with_http_info(query_more_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tquery_more_with_http_info(query_more_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tquery_more ..."
      end
      # verify the required parameter 'query_more_request' is set
      fail ArgumentError, "Missing the required parameter 'query_more_request' when calling ActionsApi.proxy_action_pos_tquery_more" if query_more_request.nil?
      # resource path
      local_var_path = "/action/queryMore".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tquery_more\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tsubscribe(subscribe_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tsubscribe_with_http_info(subscribe_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tsubscribe_with_http_info(subscribe_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tsubscribe ..."
      end
      # verify the required parameter 'subscribe_request' is set
      fail ArgumentError, "Missing the required parameter 'subscribe_request' when calling ActionsApi.proxy_action_pos_tsubscribe" if subscribe_request.nil?
      # resource path
      local_var_path = "/action/subscribe".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tsubscribe\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_action_pos_tupdate(update_request, opts = {})
      data, _status_code, _headers = proxy_action_pos_tupdate_with_http_info(update_request, opts)
      return data
    end
    ...
    def proxy_action_pos_tupdate_with_http_info(update_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ActionsApi.proxy_action_pos_tupdate ..."
      end
      # verify the required parameter 'update_request' is set
      fail ArgumentError, "Missing the required parameter 'update_request' when calling ActionsApi.proxy_action_pos_tupdate" if update_request.nil?
      # resource path
      local_var_path = "/action/update".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsApi#proxy_action_pos_tupdate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
