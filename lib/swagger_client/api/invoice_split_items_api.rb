...
module SwaggerClient
  class InvoiceSplitItemsApi
    ...
    def proxy_delete_invoice_split_item(id, opts = {})
      data, _status_code, _headers = proxy_delete_invoice_split_item_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_invoice_split_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceSplitItemsApi.proxy_delete_invoice_split_item ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceSplitItemsApi.proxy_delete_invoice_split_item" if id.nil?
      # resource path
      local_var_path = "/object/invoice-split-item/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceSplitItemsApi#proxy_delete_invoice_split_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_invoice_split_item(id, opts = {})
      data, _status_code, _headers = proxy_get_invoice_split_item_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetInvoiceSplitItem, Fixnum, Hash)>] ProxyGetInvoiceSplitItem data, response status code and response headers
    def proxy_get_invoice_split_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceSplitItemsApi.proxy_get_invoice_split_item ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceSplitItemsApi.proxy_get_invoice_split_item" if id.nil?
      # resource path
      local_var_path = "/object/invoice-split-item/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetInvoiceSplitItem')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceSplitItemsApi#proxy_get_invoice_split_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
