...
module SwaggerClient
  class RevenueEventsApi
    ...
    def g_et_revenue_event_details(rs_number, opts = {})
      data, _status_code, _headers = g_et_revenue_event_details_with_http_info(rs_number, opts)
      return data
    end
    ...
    # @param rs_number Revenue schedule number. The revenue schedule number is always prefixed with \&quot;RS\&quot;, for example, \&quot;RS-00000001\&quot;.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETRevenueEventDetailsType, Fixnum, Hash)>] GETRevenueEventDetailsType data, response status code and response headers
    def g_et_revenue_event_details_with_http_info(rs_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueEventsApi.g_et_revenue_event_details ..."
      end
      # verify the required parameter 'rs_number' is set
      fail ArgumentError, "Missing the required parameter 'rs_number' when calling RevenueEventsApi.g_et_revenue_event_details" if rs_number.nil?
      # resource path
      local_var_path = "/revenue-events/revenue-schedules/{rs-number}".sub('{format}','json').sub('{' + 'rs-number' + '}', rs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRevenueEventDetailsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueEventsApi#g_et_revenue_event_details\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_revenue_event_details_0(event_number, opts = {})
      data, _status_code, _headers = g_et_revenue_event_details_0_with_http_info(event_number, opts)
      return data
    end
    ...
    # @param event_number The number associated with the revenue event.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETRevenueEventDetailType, Fixnum, Hash)>] GETRevenueEventDetailType data, response status code and response headers
    def g_et_revenue_event_details_0_with_http_info(event_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueEventsApi.g_et_revenue_event_details_0 ..."
      end
      # verify the required parameter 'event_number' is set
      fail ArgumentError, "Missing the required parameter 'event_number' when calling RevenueEventsApi.g_et_revenue_event_details_0" if event_number.nil?
      # resource path
      local_var_path = "/revenue-events/{event-number}".sub('{format}','json').sub('{' + 'event-number' + '}', event_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETRevenueEventDetailType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueEventsApi#g_et_revenue_event_details_0\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
