...
module SwaggerClient
  class InvoicesApi
    ...
    def proxy_delete_invoice(id, opts = {})
      data, _status_code, _headers = proxy_delete_invoice_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_invoice_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.proxy_delete_invoice ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.proxy_delete_invoice" if id.nil?
      # resource path
      local_var_path = "/object/invoice/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#proxy_delete_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_invoice(id, opts = {})
      data, _status_code, _headers = proxy_get_invoice_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_get_invoice_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.proxy_get_invoice ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.proxy_get_invoice" if id.nil?
      # resource path
      local_var_path = "/object/invoice/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#proxy_get_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_invoice(create_request, opts = {})
      data, _status_code, _headers = proxy_post_invoice_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_invoice_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.proxy_post_invoice ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling InvoicesApi.proxy_post_invoice" if create_request.nil?
      # resource path
      local_var_path = "/object/invoice".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#proxy_post_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ProxyCreateOrModifyResponse]
    def proxy_put_invoice(id, modify_request, opts = {})
      data, _status_code, _headers = proxy_put_invoice_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def proxy_put_invoice_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoicesApi.proxy_put_invoice ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoicesApi.proxy_put_invoice" if id.nil?
      # verify the required parameter 'modify_request' is set
      fail ArgumentError, "Missing the required parameter 'modify_request' when calling InvoicesApi.proxy_put_invoice" if modify_request.nil?
      # resource path
      local_var_path = "/object/invoice/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#proxy_put_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
