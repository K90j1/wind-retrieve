...
module SwaggerClient
  class InvoiceItemsApi
    ...
    def proxy_delete_invoice_item(id, opts = {})
      data, _status_code, _headers = proxy_delete_invoice_item_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_invoice_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceItemsApi.proxy_delete_invoice_item ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceItemsApi.proxy_delete_invoice_item" if id.nil?
      # resource path
      local_var_path = "/object/invoice-item/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceItemsApi#proxy_delete_invoice_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_invoice_item(id, opts = {})
      data, _status_code, _headers = proxy_get_invoice_item_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetInvoiceItem, Fixnum, Hash)>] ProxyGetInvoiceItem data, response status code and response headers
    def proxy_get_invoice_item_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceItemsApi.proxy_get_invoice_item ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceItemsApi.proxy_get_invoice_item" if id.nil?
      # resource path
      local_var_path = "/object/invoice-item/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetInvoiceItem')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceItemsApi#proxy_get_invoice_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
