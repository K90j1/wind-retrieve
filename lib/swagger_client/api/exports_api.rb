...
module SwaggerClient
  class ExportsApi
    ...
    def proxy_delete_export(id, opts = {})
      data, _status_code, _headers = proxy_delete_export_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_export_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ExportsApi.proxy_delete_export ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ExportsApi.proxy_delete_export" if id.nil?
      # resource path
      local_var_path = "/object/export/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExportsApi#proxy_delete_export\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_export(id, opts = {})
      data, _status_code, _headers = proxy_get_export_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetExport, Fixnum, Hash)>] ProxyGetExport data, response status code and response headers
    def proxy_get_export_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ExportsApi.proxy_get_export ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ExportsApi.proxy_get_export" if id.nil?
      # resource path
      local_var_path = "/object/export/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetExport')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExportsApi#proxy_get_export\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_export(create_request, opts = {})
      data, _status_code, _headers = proxy_post_export_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_export_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ExportsApi.proxy_post_export ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling ExportsApi.proxy_post_export" if create_request.nil?
      # resource path
      local_var_path = "/object/export".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExportsApi#proxy_post_export\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
