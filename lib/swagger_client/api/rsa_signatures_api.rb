...
module SwaggerClient
  class RSASignaturesApi
    ...
    def p_ost_decrypt_response(request, opts = {})
      data, _status_code, _headers = p_ost_decrypt_response_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTDecryptResponseType, Fixnum, Hash)>] POSTDecryptResponseType data, response status code and response headers
    def p_ost_decrypt_response_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RSASignaturesApi.p_ost_decrypt_response ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling RSASignaturesApi.p_ost_decrypt_response" if request.nil?
      # resource path
      local_var_path = "/rsa-signatures/decrypt".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTDecryptResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RSASignaturesApi#p_ost_decrypt_response\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def p_ostrsa_signature(request, opts = {})
      data, _status_code, _headers = p_ostrsa_signature_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTRSASignatureResponseType, Fixnum, Hash)>] POSTRSASignatureResponseType data, response status code and response headers
    def p_ostrsa_signature_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RSASignaturesApi.p_ostrsa_signature ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling RSASignaturesApi.p_ostrsa_signature" if request.nil?
      # resource path
      local_var_path = "/rsa-signatures".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTRSASignatureResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RSASignaturesApi#p_ostrsa_signature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
