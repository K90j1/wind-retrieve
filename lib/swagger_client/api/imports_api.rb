...
module SwaggerClient
  class ImportsApi
    ...
    def proxy_delete_import(id, opts = {})
      data, _status_code, _headers = proxy_delete_import_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_import_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ImportsApi.proxy_delete_import ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ImportsApi.proxy_delete_import" if id.nil?
      # resource path
      local_var_path = "/object/import/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ImportsApi#proxy_delete_import\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_import(id, opts = {})
      data, _status_code, _headers = proxy_get_import_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetImport, Fixnum, Hash)>] ProxyGetImport data, response status code and response headers
    def proxy_get_import_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ImportsApi.proxy_get_import ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ImportsApi.proxy_get_import" if id.nil?
      # resource path
      local_var_path = "/object/import/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetImport')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ImportsApi#proxy_get_import\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
