...
module SwaggerClient
  class RefundsApi
    ...
    def proxy_delete_refund(id, opts = {})
      data, _status_code, _headers = proxy_delete_refund_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_refund_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RefundsApi.proxy_delete_refund ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling RefundsApi.proxy_delete_refund" if id.nil?
      # resource path
      local_var_path = "/object/refund/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#proxy_delete_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_refund(id, opts = {})
      data, _status_code, _headers = proxy_get_refund_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_get_refund_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RefundsApi.proxy_get_refund ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling RefundsApi.proxy_get_refund" if id.nil?
      # resource path
      local_var_path = "/object/refund/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#proxy_get_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_refund(create_request, opts = {})
      data, _status_code, _headers = proxy_post_refund_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_refund_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RefundsApi.proxy_post_refund ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling RefundsApi.proxy_post_refund" if create_request.nil?
      # resource path
      local_var_path = "/object/refund".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#proxy_post_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ProxyCreateOrModifyResponse]
    def proxy_put_refund(id, modify_request, opts = {})
      data, _status_code, _headers = proxy_put_refund_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def proxy_put_refund_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RefundsApi.proxy_put_refund ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling RefundsApi.proxy_put_refund" if id.nil?
      # verify the required parameter 'modify_request' is set
      fail ArgumentError, "Missing the required parameter 'modify_request' when calling RefundsApi.proxy_put_refund" if modify_request.nil?
      # resource path
      local_var_path = "/object/refund/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RefundsApi#proxy_put_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
