...
module SwaggerClient
  class OperationsApi
    ...
    def p_ost_transaction_invoice_payment(request, opts = {})
      data, _status_code, _headers = p_ost_transaction_invoice_payment_with_http_info(request, opts)
      return data
    end
    ...
    # @param request Customer account ID or account number.
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTInvoiceCollectResponseType, Fixnum, Hash)>] POSTInvoiceCollectResponseType data, response status code and response headers
    def p_ost_transaction_invoice_payment_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OperationsApi.p_ost_transaction_invoice_payment ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling OperationsApi.p_ost_transaction_invoice_payment" if request.nil?
      # resource path
      local_var_path = "/operations/invoice-collect".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTInvoiceCollectResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OperationsApi#p_ost_transaction_invoice_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
