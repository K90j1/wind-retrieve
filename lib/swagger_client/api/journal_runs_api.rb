...
module SwaggerClient
  class JournalRunsApi
    ...
    # @param jr_number Journal run number. Must be a valid journal run number in the format &#x60;JR-00000001&#x60;. 
    # @param [Hash] opts the optional parameters
    # @return [CommonResponseType]
    def d_elete_journal_run(jr_number, opts = {})
      data, _status_code, _headers = d_elete_journal_run_with_http_info(jr_number, opts)
      return data
    end
    ...
    def d_elete_journal_run_with_http_info(jr_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: JournalRunsApi.d_elete_journal_run ..."
      end
      # verify the required parameter 'jr_number' is set
      fail ArgumentError, "Missing the required parameter 'jr_number' when calling JournalRunsApi.d_elete_journal_run" if jr_number.nil?
      # resource path
      local_var_path = "/journal-runs/{jr-number}".sub('{format}','json').sub('{' + 'jr-number' + '}', jr_number.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JournalRunsApi#d_elete_journal_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_journal_run(jr_number, opts = {})
      data, _status_code, _headers = g_et_journal_run_with_http_info(jr_number, opts)
      return data
    end
    ...
    # @param jr_number Journal run number. Must be a valid journal run number in the format &#x60;JR-00000001&#x60;. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETJournalRunType, Fixnum, Hash)>] GETJournalRunType data, response status code and response headers
    def g_et_journal_run_with_http_info(jr_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: JournalRunsApi.g_et_journal_run ..."
      end
      # verify the required parameter 'jr_number' is set
      fail ArgumentError, "Missing the required parameter 'jr_number' when calling JournalRunsApi.g_et_journal_run" if jr_number.nil?
      # resource path
      local_var_path = "/journal-runs/{jr-number}".sub('{format}','json').sub('{' + 'jr-number' + '}', jr_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETJournalRunType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JournalRunsApi#g_et_journal_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def p_ost_journal_run(request, opts = {})
      data, _status_code, _headers = p_ost_journal_run_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTJournalRunResponseType, Fixnum, Hash)>] POSTJournalRunResponseType data, response status code and response headers
    def p_ost_journal_run_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: JournalRunsApi.p_ost_journal_run ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling JournalRunsApi.p_ost_journal_run" if request.nil?
      # resource path
      local_var_path = "/journal-runs".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTJournalRunResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JournalRunsApi#p_ost_journal_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param jr_number Journal run number. Must be a valid journal run number in the format JR-00000001.  You can only cancel a journal run whose status is \&quot;Pending\&quot;, \&quot;Error\&quot;, or \&quot;Completed\&quot;. 
    # @param [Hash] opts the optional parameters
    # @return [CommonResponseType]
    def p_ut_journal_run(jr_number, opts = {})
      data, _status_code, _headers = p_ut_journal_run_with_http_info(jr_number, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CommonResponseType, Fixnum, Hash)>] CommonResponseType data, response status code and response headers
    def p_ut_journal_run_with_http_info(jr_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: JournalRunsApi.p_ut_journal_run ..."
      end
      # verify the required parameter 'jr_number' is set
      fail ArgumentError, "Missing the required parameter 'jr_number' when calling JournalRunsApi.p_ut_journal_run" if jr_number.nil?
      # resource path
      local_var_path = "/journal-runs/{jr-number}/cancel".sub('{format}','json').sub('{' + 'jr-number' + '}', jr_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'CommonResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JournalRunsApi#p_ut_journal_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
