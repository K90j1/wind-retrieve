...
module SwaggerClient
  class GetFilesApi
    ...
    # @param file_id The Zuora ID of the file you want to retrieve.  See [Get Accounting Period](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Accounting_Periods/Get_Accounting_Period) for getting file IDs of accounting period reports, such as the Revenue Detail report. 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def g_et_files(file_id, opts = {})
      g_et_files_with_http_info(file_id, opts)
      return nil
    end
    ...
    def g_et_files_with_http_info(file_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GetFilesApi.g_et_files ..."
      end
      # verify the required parameter 'file_id' is set
      fail ArgumentError, "Missing the required parameter 'file_id' when calling GetFilesApi.g_et_files" if file_id.nil?
      # resource path
      local_var_path = "/files/{file-id}".sub('{format}','json').sub('{' + 'file-id' + '}', file_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetFilesApi#g_et_files\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
