...
module SwaggerClient
  class TransactionsApi
    ...
    def g_et_invoice(account_key, opts = {})
      data, _status_code, _headers = g_et_invoice_with_http_info(account_key, opts)
      return data
    end
    ...
    # @param account_key Account number or account ID. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETInvoiceFileWrapper, Fixnum, Hash)>] GETInvoiceFileWrapper data, response status code and response headers
    def g_et_invoice_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TransactionsApi.g_et_invoice ..."
      end
      # verify the required parameter 'account_key' is set
      fail ArgumentError, "Missing the required parameter 'account_key' when calling TransactionsApi.g_et_invoice" if account_key.nil?
      # resource path
      local_var_path = "/transactions/invoices/accounts/{account-key}".sub('{format}','json').sub('{' + 'account-key' + '}', account_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETInvoiceFileWrapper')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#g_et_invoice\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def g_et_payments(account_key, opts = {})
      data, _status_code, _headers = g_et_payments_with_http_info(account_key, opts)
      return data
    end
    ...
    # @param account_key Account number or account ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETPaymentsType, Fixnum, Hash)>] GETPaymentsType data, response status code and response headers
    def g_et_payments_with_http_info(account_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TransactionsApi.g_et_payments ..."
      end
      # verify the required parameter 'account_key' is set
      fail ArgumentError, "Missing the required parameter 'account_key' when calling TransactionsApi.g_et_payments" if account_key.nil?
      # resource path
      local_var_path = "/transactions/payments/accounts/{account-key}".sub('{format}','json').sub('{' + 'account-key' + '}', account_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GETPaymentsType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#g_et_payments\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
