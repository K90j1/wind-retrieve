...
module SwaggerClient
  class PaymentsApi
    ...
    def proxy_delete_payment(id, opts = {})
      data, _status_code, _headers = proxy_delete_payment_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_payment_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentsApi.proxy_delete_payment ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.proxy_delete_payment" if id.nil?
      # resource path
      local_var_path = "/object/payment/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#proxy_delete_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_payment(id, opts = {})
      data, _status_code, _headers = proxy_get_payment_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_get_payment_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentsApi.proxy_get_payment ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.proxy_get_payment" if id.nil?
      # resource path
      local_var_path = "/object/payment/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#proxy_get_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_payment(create_request, opts = {})
      data, _status_code, _headers = proxy_post_payment_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_payment_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentsApi.proxy_post_payment ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling PaymentsApi.proxy_post_payment" if create_request.nil?
      # resource path
      local_var_path = "/object/payment".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#proxy_post_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ProxyCreateOrModifyResponse]
    def proxy_put_payment(id, modify_request, opts = {})
      data, _status_code, _headers = proxy_put_payment_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def proxy_put_payment_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentsApi.proxy_put_payment ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.proxy_put_payment" if id.nil?
      # verify the required parameter 'modify_request' is set
      fail ArgumentError, "Missing the required parameter 'modify_request' when calling PaymentsApi.proxy_put_payment" if modify_request.nil?
      # resource path
      local_var_path = "/object/payment/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#proxy_put_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
