...
module SwaggerClient
  class ChargeRevenueSummariesApi
    ...
    def g_etcrs_by_charge_id(charge_key, opts = {})
      data, _status_code, _headers = g_etcrs_by_charge_id_with_http_info(charge_key, opts)
      return data
    end
    ...
    # @param charge_key ID of the subscription rate plan charge; for example, 402892793e173340013e173b81000012. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETChargeRSDetailType, Fixnum, Hash)>] GETChargeRSDetailType data, response status code and response headers
    def g_etcrs_by_charge_id_with_http_info(charge_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ChargeRevenueSummariesApi.g_etcrs_by_charge_id ..."
      end
      # verify the required parameter 'charge_key' is set
      fail ArgumentError, "Missing the required parameter 'charge_key' when calling ChargeRevenueSummariesApi.g_etcrs_by_charge_id" if charge_key.nil?
      # resource path
      local_var_path = "/charge-revenue-summaries/subscription-charges/{charge-key}".sub('{format}','json').sub('{' + 'charge-key' + '}', charge_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETChargeRSDetailType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChargeRevenueSummariesApi#g_etcrs_by_charge_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GETChargeRSDetailType]
    def g_etcrs_by_crs_number(crs_number, opts = {})
      data, _status_code, _headers = g_etcrs_by_crs_number_with_http_info(crs_number, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETChargeRSDetailType, Fixnum, Hash)>] GETChargeRSDetailType data, response status code and response headers
    def g_etcrs_by_crs_number_with_http_info(crs_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ChargeRevenueSummariesApi.g_etcrs_by_crs_number ..."
      end
      # verify the required parameter 'crs_number' is set
      fail ArgumentError, "Missing the required parameter 'crs_number' when calling ChargeRevenueSummariesApi.g_etcrs_by_crs_number" if crs_number.nil?
      # resource path
      local_var_path = "/charge-revenue-summaries/{crs-number}".sub('{format}','json').sub('{' + 'crs-number' + '}', crs_number.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETChargeRSDetailType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChargeRevenueSummariesApi#g_etcrs_by_crs_number\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
