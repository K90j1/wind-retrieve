...
module SwaggerClient
  class QuotesDocumentApi
    ...
    def p_ost_quote_doc(request, opts = {})
      data, _status_code, _headers = p_ost_quote_doc_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTQuoteDocResponseType, Fixnum, Hash)>] POSTQuoteDocResponseType data, response status code and response headers
    def p_ost_quote_doc_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: QuotesDocumentApi.p_ost_quote_doc ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling QuotesDocumentApi.p_ost_quote_doc" if request.nil?
      # resource path
      local_var_path = "/quotes/document".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTQuoteDocResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: QuotesDocumentApi#p_ost_quote_doc\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
