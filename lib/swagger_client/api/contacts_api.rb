...
module SwaggerClient
  class ContactsApi
    ...
    def proxy_delete_contact(id, opts = {})
      data, _status_code, _headers = proxy_delete_contact_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_contact_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContactsApi.proxy_delete_contact ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.proxy_delete_contact" if id.nil?
      # resource path
      local_var_path = "/object/contact/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#proxy_delete_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_contact(id, opts = {})
      data, _status_code, _headers = proxy_get_contact_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_get_contact_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContactsApi.proxy_get_contact ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.proxy_get_contact" if id.nil?
      # resource path
      local_var_path = "/object/contact/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#proxy_get_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_contact(create_request, opts = {})
      data, _status_code, _headers = proxy_post_contact_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_contact_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContactsApi.proxy_post_contact ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling ContactsApi.proxy_post_contact" if create_request.nil?
      # resource path
      local_var_path = "/object/contact".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#proxy_post_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ProxyCreateOrModifyResponse]
    def proxy_put_contact(id, modify_request, opts = {})
      data, _status_code, _headers = proxy_put_contact_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def proxy_put_contact_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContactsApi.proxy_put_contact ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.proxy_put_contact" if id.nil?
      # verify the required parameter 'modify_request' is set
      fail ArgumentError, "Missing the required parameter 'modify_request' when calling ContactsApi.proxy_put_contact" if modify_request.nil?
      # resource path
      local_var_path = "/object/contact/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#proxy_put_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
