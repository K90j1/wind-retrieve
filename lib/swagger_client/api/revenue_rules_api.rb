...
module SwaggerClient
  class RevenueRulesApi
    ...
    def g_et_revenue_recognition_rule_association(charge_key, opts = {})
      data, _status_code, _headers = g_et_revenue_recognition_rule_association_with_http_info(charge_key, opts)
      return data
    end
    ...
    # @param charge_key ID of the subscription rate plan charge; for example, 402892793e173340013e173b81000012.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETRevenueRecognitionRuleAssociationType, Fixnum, Hash)>] GETRevenueRecognitionRuleAssociationType data, response status code and response headers
    def g_et_revenue_recognition_rule_association_with_http_info(charge_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RevenueRulesApi.g_et_revenue_recognition_rule_association ..."
      end
      # verify the required parameter 'charge_key' is set
      fail ArgumentError, "Missing the required parameter 'charge_key' when calling RevenueRulesApi.g_et_revenue_recognition_rule_association" if charge_key.nil?
      # resource path
      local_var_path = "/revenue-recognition-rules/subscription-charges/{charge-key}".sub('{format}','json').sub('{' + 'charge-key' + '}', charge_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRevenueRecognitionRuleAssociationType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RevenueRulesApi#g_et_revenue_recognition_rule_association\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
