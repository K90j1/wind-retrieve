...
module SwaggerClient
  class PaymentTransactionLogsApi
    ...
    def proxy_delete_payment_transaction_log(id, opts = {})
      data, _status_code, _headers = proxy_delete_payment_transaction_log_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_payment_transaction_log_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentTransactionLogsApi.proxy_delete_payment_transaction_log ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PaymentTransactionLogsApi.proxy_delete_payment_transaction_log" if id.nil?
      # resource path
      local_var_path = "/object/payment-transaction-log/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTransactionLogsApi#proxy_delete_payment_transaction_log\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_payment_transaction_log(id, opts = {})
      data, _status_code, _headers = proxy_get_payment_transaction_log_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetPaymentTransactionLog, Fixnum, Hash)>] ProxyGetPaymentTransactionLog data, response status code and response headers
    def proxy_get_payment_transaction_log_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PaymentTransactionLogsApi.proxy_get_payment_transaction_log ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PaymentTransactionLogsApi.proxy_get_payment_transaction_log" if id.nil?
      # resource path
      local_var_path = "/object/payment-transaction-log/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetPaymentTransactionLog')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentTransactionLogsApi#proxy_get_payment_transaction_log\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
