...
module SwaggerClient
  class ConnectionsApi
    ...
    # @param api_access_key_id Account username 
    # @param api_secret_access_key Account password 
    # @param content_type Must be set to \&quot;application/json\&quot; 
    # @param [Hash] opts the optional parameters
    # @return [CommonResponseType]
    def p_ost_connections(api_access_key_id, api_secret_access_key, content_type, opts = {})
      data, _status_code, _headers = p_ost_connections_with_http_info(api_access_key_id, api_secret_access_key, content_type, opts)
      return data
    end
    ...
    def p_ost_connections_with_http_info(api_access_key_id, api_secret_access_key, content_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionsApi.p_ost_connections ..."
      end
      # verify the required parameter 'api_access_key_id' is set
      fail ArgumentError, "Missing the required parameter 'api_access_key_id' when calling ConnectionsApi.p_ost_connections" if api_access_key_id.nil?
      # verify the required parameter 'api_secret_access_key' is set
      fail ArgumentError, "Missing the required parameter 'api_secret_access_key' when calling ConnectionsApi.p_ost_connections" if api_secret_access_key.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling ConnectionsApi.p_ost_connections" if content_type.nil?
      # resource path
      local_var_path = "/connections".sub('{format}','json')
      ...
      header_params[:'apiAccessKeyId'] = api_access_key_id
      header_params[:'apiSecretAccessKey'] = api_secret_access_key
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionsApi#p_ost_connections\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
