...
module SwaggerClient
  class ProductRatePlanChargesApi
    ...
    def proxy_delete_product_rate_plan_charge(id, opts = {})
      data, _status_code, _headers = proxy_delete_product_rate_plan_charge_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_product_rate_plan_charge_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductRatePlanChargesApi.proxy_delete_product_rate_plan_charge ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductRatePlanChargesApi.proxy_delete_product_rate_plan_charge" if id.nil?
      # resource path
      local_var_path = "/object/product-rate-plan-charge/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlanChargesApi#proxy_delete_product_rate_plan_charge\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_product_rate_plan_charge(id, opts = {})
      data, _status_code, _headers = proxy_get_product_rate_plan_charge_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetProductRatePlanCharge, Fixnum, Hash)>] ProxyGetProductRatePlanCharge data, response status code and response headers
    def proxy_get_product_rate_plan_charge_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductRatePlanChargesApi.proxy_get_product_rate_plan_charge ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductRatePlanChargesApi.proxy_get_product_rate_plan_charge" if id.nil?
      # resource path
      local_var_path = "/object/product-rate-plan-charge/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetProductRatePlanCharge')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductRatePlanChargesApi#proxy_get_product_rate_plan_charge\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
