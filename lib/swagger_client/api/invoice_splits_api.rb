...
module SwaggerClient
  class InvoiceSplitsApi
    ...
    def proxy_delete_invoice_split(id, opts = {})
      data, _status_code, _headers = proxy_delete_invoice_split_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_invoice_split_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceSplitsApi.proxy_delete_invoice_split ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceSplitsApi.proxy_delete_invoice_split" if id.nil?
      # resource path
      local_var_path = "/object/invoice-split/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceSplitsApi#proxy_delete_invoice_split\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_invoice_split(id, opts = {})
      data, _status_code, _headers = proxy_get_invoice_split_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetInvoiceSplit, Fixnum, Hash)>] ProxyGetInvoiceSplit data, response status code and response headers
    def proxy_get_invoice_split_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InvoiceSplitsApi.proxy_get_invoice_split ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling InvoiceSplitsApi.proxy_get_invoice_split" if id.nil?
      # resource path
      local_var_path = "/object/invoice-split/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetInvoiceSplit')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoiceSplitsApi#proxy_get_invoice_split\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
