...
module SwaggerClient
  class HMACSignaturesApi
    ...
    def p_osthmac_signature(request, opts = {})
      data, _status_code, _headers = p_osthmac_signature_with_http_info(request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTHMACSignatureResponseType, Fixnum, Hash)>] POSTHMACSignatureResponseType data, response status code and response headers
    def p_osthmac_signature_with_http_info(request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: HMACSignaturesApi.p_osthmac_signature ..."
      end
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling HMACSignaturesApi.p_osthmac_signature" if request.nil?
      # resource path
      local_var_path = "/hmac-signatures".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'POSTHMACSignatureResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: HMACSignaturesApi#p_osthmac_signature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
