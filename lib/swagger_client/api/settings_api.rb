...
module SwaggerClient
  class SettingsApi
    ...
    def g_et_revenue_start_date_setting(opts = {})
      data, _status_code, _headers = g_et_revenue_start_date_setting_with_http_info(opts)
      return data
    end
    ...
    # This REST API reference describes how to get the revenue automation start date. Request and response field descriptions and sample code are provided. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETRevenueStartDateSettingType, Fixnum, Hash)>] GETRevenueStartDateSettingType data, response status code and response headers
    def g_et_revenue_start_date_setting_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SettingsApi.g_et_revenue_start_date_setting ..."
      end
      # resource path
      local_var_path = "/settings/finance/revenue-automation-start-date".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETRevenueStartDateSettingType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsApi#g_et_revenue_start_date_setting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
