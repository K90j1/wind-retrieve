...
module SwaggerClient
  class ProductsApi
    ...
    def proxy_delete_product(id, opts = {})
      data, _status_code, _headers = proxy_delete_product_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_product_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductsApi.proxy_delete_product ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductsApi.proxy_delete_product" if id.nil?
      # resource path
      local_var_path = "/object/product/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#proxy_delete_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_product(id, opts = {})
      data, _status_code, _headers = proxy_get_product_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_get_product_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductsApi.proxy_get_product ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductsApi.proxy_get_product" if id.nil?
      # resource path
      local_var_path = "/object/product/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#proxy_get_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def proxy_post_product(create_request, opts = {})
      data, _status_code, _headers = proxy_post_product_with_http_info(create_request, opts)
      return data
    end
    ...
    def proxy_post_product_with_http_info(create_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductsApi.proxy_post_product ..."
      end
      # verify the required parameter 'create_request' is set
      fail ArgumentError, "Missing the required parameter 'create_request' when calling ProductsApi.proxy_post_product" if create_request.nil?
      # resource path
      local_var_path = "/object/product".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#proxy_post_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ProxyCreateOrModifyResponse]
    def proxy_put_product(id, modify_request, opts = {})
      data, _status_code, _headers = proxy_put_product_with_http_info(id, modify_request, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProxyCreateOrModifyResponse, Fixnum, Hash)>] ProxyCreateOrModifyResponse data, response status code and response headers
    def proxy_put_product_with_http_info(id, modify_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ProductsApi.proxy_put_product ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ProductsApi.proxy_put_product" if id.nil?
      # verify the required parameter 'modify_request' is set
      fail ArgumentError, "Missing the required parameter 'modify_request' when calling ProductsApi.proxy_put_product" if modify_request.nil?
      # resource path
      local_var_path = "/object/product/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ProxyCreateOrModifyResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductsApi#proxy_put_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
