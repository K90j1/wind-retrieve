...
module SwaggerClient
  class MassUpdaterApi
    ...
    # @param bulk_key String of 32 characters that identifies a mass action. You get the bulk-key after [performing a mass action](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Mass_Updater/A_Perform_Mass_Action) through the REST API. 
    # @param [Hash] opts the optional parameters
    # @return [GETMassUpdateType]
    def g_et_mass_update(bulk_key, opts = {})
      data, _status_code, _headers = g_et_mass_update_with_http_info(bulk_key, opts)
      return data
    end
    ...
    # @param bulk_key String of 32 characters that identifies a mass action. You get the bulk-key after [performing a mass action](https://knowledgecenter.zuora.com/DC_Developers/REST_API/B_REST_API_reference/Mass_Updater/A_Perform_Mass_Action) through the REST API. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GETMassUpdateType, Fixnum, Hash)>] GETMassUpdateType data, response status code and response headers
    def g_et_mass_update_with_http_info(bulk_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MassUpdaterApi.g_et_mass_update ..."
      end
      # verify the required parameter 'bulk_key' is set
      fail ArgumentError, "Missing the required parameter 'bulk_key' when calling MassUpdaterApi.g_et_mass_update" if bulk_key.nil?
      # resource path
      local_var_path = "/bulk/{bulk-key}".sub('{format}','json').sub('{' + 'bulk-key' + '}', bulk_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'GETMassUpdateType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MassUpdaterApi#g_et_mass_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param content_type Must be multipart/form-data. 
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [POSTMassUpdateResponseType]
    def p_ost_mass_update(content_type, request, opts = {})
      data, _status_code, _headers = p_ost_mass_update_with_http_info(content_type, request, opts)
      return data
    end
    ...
    # @param request 
    # @param [Hash] opts the optional parameters
    # @return [Array<(POSTMassUpdateResponseType, Fixnum, Hash)>] POSTMassUpdateResponseType data, response status code and response headers
    def p_ost_mass_update_with_http_info(content_type, request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MassUpdaterApi.p_ost_mass_update ..."
      end
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling MassUpdaterApi.p_ost_mass_update" if content_type.nil?
      # verify the required parameter 'request' is set
      fail ArgumentError, "Missing the required parameter 'request' when calling MassUpdaterApi.p_ost_mass_update" if request.nil?
      # resource path
      local_var_path = "/bulk".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'POSTMassUpdateResponseType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MassUpdaterApi#p_ost_mass_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bulk_key String of 32 characters that identifies a mass action. You get the bulk-key after [performing a mass action](https://knowledgecenter.zuora.com/BC_Developers/REST_API/B_REST_API_reference/Mass_Updater/A_Perform_Mass_Action) through the REST API. 
    # @param [Hash] opts the optional parameters
    # @return [CommonResponseType]
    def p_ut_mass_updater(bulk_key, opts = {})
      data, _status_code, _headers = p_ut_mass_updater_with_http_info(bulk_key, opts)
      return data
    end
    ...
    def p_ut_mass_updater_with_http_info(bulk_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MassUpdaterApi.p_ut_mass_updater ..."
      end
      # verify the required parameter 'bulk_key' is set
      fail ArgumentError, "Missing the required parameter 'bulk_key' when calling MassUpdaterApi.p_ut_mass_updater" if bulk_key.nil?
      # resource path
      local_var_path = "/bulk/{bulk-key}/stop".sub('{format}','json').sub('{' + 'bulk-key' + '}', bulk_key.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MassUpdaterApi#p_ut_mass_updater\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
