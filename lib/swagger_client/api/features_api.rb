...
module SwaggerClient
  class FeaturesApi
    ...
    def proxy_delete_feature(id, opts = {})
      data, _status_code, _headers = proxy_delete_feature_with_http_info(id, opts)
      return data
    end
    ...
    def proxy_delete_feature_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FeaturesApi.proxy_delete_feature ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling FeaturesApi.proxy_delete_feature" if id.nil?
      # resource path
      local_var_path = "/object/feature/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#proxy_delete_feature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def proxy_get_feature(id, opts = {})
      data, _status_code, _headers = proxy_get_feature_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Object fields to return
    # @return [Array<(ProxyGetFeature, Fixnum, Hash)>] ProxyGetFeature data, response status code and response headers
    def proxy_get_feature_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FeaturesApi.proxy_get_feature ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling FeaturesApi.proxy_get_feature" if id.nil?
      # resource path
      local_var_path = "/object/feature/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ProxyGetFeature')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FeaturesApi#proxy_get_feature\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
