  ...
  class SubscribeResult
    ...
    def self.swagger_types
      {
        ...
        :'charge_metrics_data' => :'Array<ChargeMetricsData>',
        :'errors' => :'Array<Error>',
        ...
        :'invoice_result' => :'Array<InvoiceResult>',
        :'payment_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ChargeMetricsData')
        if (value = attributes[:'ChargeMetricsData']).is_a?(Array)
          self.charge_metrics_data = value
        end
      end
      ...
      if attributes.has_key?(:'InvoiceResult')
        if (value = attributes[:'InvoiceResult']).is_a?(Array)
          self.invoice_result = value
        end
      end
