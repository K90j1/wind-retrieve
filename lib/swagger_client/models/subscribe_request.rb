  ...
  class SubscribeRequest
    ...
    def self.swagger_types
      {
        ...
        :'bill_to_contact' => :'Array<Contact>',
        :'payment_method' => :'Array<PaymentMethod>',
        :'preview_options' => :'Array<PreviewOptions>',
        :'sold_to_contact' => :'Array<Contact>',
        :'subscribe_options' => :'Array<SubscribeOptions>',
        :'subscription_data' => :'Array<SubscriptionData>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'BillToContact')
        if (value = attributes[:'BillToContact']).is_a?(Array)
          self.bill_to_contact = value
        end
      end

      if attributes.has_key?(:'PaymentMethod')
        if (value = attributes[:'PaymentMethod']).is_a?(Array)
          self.payment_method = value
        end
      end

      if attributes.has_key?(:'PreviewOptions')
        if (value = attributes[:'PreviewOptions']).is_a?(Array)
          self.preview_options = value
        end
      end

      if attributes.has_key?(:'SoldToContact')
        if (value = attributes[:'SoldToContact']).is_a?(Array)
          self.sold_to_contact = value
        end
      end

      if attributes.has_key?(:'SubscribeOptions')
        if (value = attributes[:'SubscribeOptions']).is_a?(Array)
          self.subscribe_options = value
        end
      end

      if attributes.has_key?(:'SubscriptionData')
        if (value = attributes[:'SubscriptionData']).is_a?(Array)
