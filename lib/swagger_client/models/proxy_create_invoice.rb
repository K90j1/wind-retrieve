...
module SwaggerClient
  ...
  class ProxyCreateInvoice
    ...
    def valid?
      ...
      return false if @adjustment_amount.nil?
      return false if @body.nil?
      return false if @credit_balance_adjustment_amount.nil?
      return false if @payment_amount.nil?
      return false if @refund_amount.nil?
      return false if @tax_amount.nil?
      return false if @tax_exempt_amount.nil?
      return true
    end
    ...
    def hash
      [account_id, adjustment_amount, body, credit_balance_adjustment_amount, includes_one_time, includes_recurring, includes_usage, invoice_date, payment_amount, refund_amount, target_date, tax_amount, tax_exempt_amount].hash
    end
