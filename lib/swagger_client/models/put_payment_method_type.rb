...
module SwaggerClient
  ...
  class PUTPaymentMethodType
    ...
    def hash
      [address_line1, address_line2, card_holder_name, city, country, default_payment_method, email, expiration_month, expiration_year, phone, security_code, state, zip_code].hash
    end
