...
module SwaggerClient
  ...
  class PUTSubscriptionType
    ...
    def hash
      [cpq_bundle_json_id__qt, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, add, apply_credit_balance, auto_renew, current_term, current_term_period_type, custom_field__c, include_existing_draft_invoice_items, invoice, invoice_collect, invoice_separately, invoice_target_date, notes, preview, preview_type, remove, renewal_setting, renewal_term, renewal_term_period_type, term_start_date, term_type, update].hash
    end
