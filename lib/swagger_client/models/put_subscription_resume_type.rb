...
module SwaggerClient
  ...
  class PUTSubscriptionResumeType
    ...
    def hash
      [apply_credit_balance, collect, contract_effective_date, extends_term, invoice, invoice_collect, invoice_target_date, resume_periods, resume_periods_type, resume_policy, resume_specific_date].hash
    end
