...
module SwaggerClient
  ...
  class ProxyGetProductRatePlan
    ...
    #  The date when the product rate plan expires and can't be subscribed to. **Character limit**: 29 **Values**: a valid date and time value 
    attr_accessor :effective_end_date

    #  The date when the product rate plan becomes available and can be subscribed to. **Character limit**: 29 **Values**: a valid date and time value 
