...
module SwaggerClient
  ...
  class GETCustomExchangeRatesDataTypeDATE
    ...
    attr_accessor :provider_exchange_rate_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'providerExchangeRateDate')
        self.provider_exchange_rate_date = attributes[:'providerExchangeRateDate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          currency == o.currency &&
          provider_exchange_rate_date == o.provider_exchange_rate_date
    end
    ...
    def hash
      [currency, provider_exchange_rate_date].hash
    end
