...
module SwaggerClient
  ...
  class ProxyGetRatePlan
    ...
    # The name of the rate plan. Leave this null in the Subscribe call to to inherited the `ProductRatePlan.Name` field value. **Character limit**: 100 **Values**: a string of 100 characters or fewer or inherited from ProductRatePlan.Name 
    attr_accessor :name
