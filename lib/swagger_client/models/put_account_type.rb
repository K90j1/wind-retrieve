...
module SwaggerClient
  ...
  class PUTAccountType
    ...
    def hash
      [auto_pay, batch, bill_to_contact, communication_profile_id, crm_id, custom_field__c, invoice_template_id, name, notes, payment_gateway, sold_to_contact, tagging, tax_info].hash
    end
