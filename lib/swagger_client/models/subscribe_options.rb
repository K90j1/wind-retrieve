  ...
  class SubscribeOptions
    ...
    def self.swagger_types
      {
        ...
        :'electronic_payment_options' => :'Array<ElectronicPaymentOptions>',
        :'external_payment_options' => :'Array<ExternalPaymentOptions>',
        :'generate_invoice' => :'BOOLEAN',
        :'process_payments' => :'BOOLEAN',
        :'subscribe_invoice_processing_options' => :'Array<SubscribeInvoiceProcessingOptions>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ElectronicPaymentOptions')
        if (value = attributes[:'ElectronicPaymentOptions']).is_a?(Array)
          self.electronic_payment_options = value
        end
      end

      if attributes.has_key?(:'ExternalPaymentOptions')
        if (value = attributes[:'ExternalPaymentOptions']).is_a?(Array)
          self.external_payment_options = value
        end
      end
      ...
      if attributes.has_key?(:'SubscribeInvoiceProcessingOptions')
        if (value = attributes[:'SubscribeInvoiceProcessingOptions']).is_a?(Array)
          self.subscribe_invoice_processing_options = value
        end
      end
