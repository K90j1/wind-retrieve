...
module SwaggerClient
  ...
  class POSTAccountType
    ...
    def hash
      [account_number, apply_credit_balance, auto_pay, batch, bill_cycle_day, bill_to_contact, collect, communication_profile_id, credit_card, crm_id, currency, custom_field__c, hpm_credit_card_payment_method_id, invoice, invoice_collect, invoice_target_date, invoice_template_id, name, notes, payment_gateway, payment_term, sold_to_contact, subscription, tagging, tax_info].hash
    end
