...
module SwaggerClient
  ...
  class ProxyGetInvoiceItemAdjustment
    ...
    #  The end date of the service period associated with the invoice item. Service ends one second before the date in this value. This field is required the Query call, but is inherited in other calls. **Character limit**: 29 **Values**: inherited from `InvoiceItem.ServiceEndDate` 
    attr_accessor :service_end_date

    #  The start date of the service period associated with the invoice item. Service ends one second before the date in this value. This field is required in the Query call, but is inherited in other calls. **Character limit**: 29 **Values**: inherited from `InvoiceItem.ServiceStartDate` 
