...
module SwaggerClient
  ...
  class PUTRenewSubscriptionType
    ...
    def hash
      [opportunity_close_date_qt, opportunity_name_qt, quote_business_type_qt, quote_number_qt, quote_type_qt, apply_credit_balance, collect, invoice, invoice_collect, invoice_target_date].hash
    end
