...
module SwaggerClient
  ...
  class GatewayOptionData
    ...
    def self.swagger_types
      {
        :'gateway_option' => :'Array<GatewayOption>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'GatewayOption')
        if (value = attributes[:'GatewayOption']).is_a?(Array)
          self.gateway_option = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          gateway_option == o.gateway_option
    end
