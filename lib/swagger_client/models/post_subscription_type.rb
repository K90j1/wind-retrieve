...
module SwaggerClient
  ...
  class POSTSubscriptionType
    ...
    def hash
      [cpq_bundle_json_id__qt, opportunity_close_date__qt, opportunity_name__qt, quote_business_type__qt, quote_number__qt, quote_type__qt, account_key, apply_credit_balance, auto_renew, collect, contract_effective_date, custom_field__c, customer_acceptance_date, initial_term, initial_term_period_type, invoice, invoice_collect, invoice_owner_account_key, invoice_separately, invoice_target_date, notes, renewal_setting, renewal_term, renewal_term_period_type, service_activation_date, subscribe_to_rate_plans, subscription_number, term_start_date, term_type].hash
    end
