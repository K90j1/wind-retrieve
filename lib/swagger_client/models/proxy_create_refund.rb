...
module SwaggerClient
  ...
  class ProxyCreateRefund
    ...
    def hash
      [account_id, amount, comment, gateway_state, method_type, payment_method_id, reason_code, refund_date, soft_descriptor, soft_descriptor_phone, source_type, type].hash
    end
