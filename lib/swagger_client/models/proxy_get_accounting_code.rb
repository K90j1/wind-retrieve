...
module SwaggerClient
  ...
  class ProxyGetAccountingCode
    ...
    def hash
      [category, created_by_id, created_date, gl_account_name, gl_account_number, id, name, notes, status, type, updated_by_id, updated_date].hash
    end
