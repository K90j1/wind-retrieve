...
module SwaggerClient
  ...
  class PUTSubscriptionResponseType
    ...
    def hash
      [amount, amount_without_tax, charge_metrics, invoice_id, invoice_items, invoice_target_date, paid_amount, payment_id, preview_charge_metrics_response, subscription_id, success, tax_amount, total_delta_mrr, total_delta_tcv].hash
    end
