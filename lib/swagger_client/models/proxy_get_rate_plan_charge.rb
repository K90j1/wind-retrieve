...
module SwaggerClient
  ...
  class ProxyGetRatePlanCharge
    ...
    #  The date when the charge becomes effective, and billing begins. This field is required if the `TriggerEvent` field value is `SpecificDate`. **Character limit**: 29 **Values**: a valid date and time value 
