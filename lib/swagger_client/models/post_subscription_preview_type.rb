...
module SwaggerClient
  ...
  class POSTSubscriptionPreviewType
    ...
    def hash
      [opportunity_close_date_qt, opportunity_name_qt, quote_business_type_qt, quote_number_qt, quote_type_qt, account_key, contract_effective_date, customer_acceptance_date, include_existing_draft_invoice_items, initial_term, initial_term_period_type, invoice_owner_account_key, invoice_target_date, notes, preview_account_info, preview_type, service_activation_date, subscribe_to_rate_plans, term_start_date, term_type].hash
    end
