...
module SwaggerClient
  ...
  class POSTSubscriptionPreviewResponseType
    ...
    def hash
      [amount, amount_without_tax, charge_metrics, contracted_mrr, invoice_items, invoice_target_date, preview_charge_metrics_response, success, tax_amount, total_contracted_value].hash
    end
