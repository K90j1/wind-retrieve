...
module SwaggerClient
  ...
  class SubscriptionProductFeatureList
    # 
    attr_accessor :subscription_product_feature
    ...
    def self.swagger_types
      {
        :'subscription_product_feature' => :'Array<SubscriptionProductFeature>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SubscriptionProductFeature')
        if (value = attributes[:'SubscriptionProductFeature']).is_a?(Array)
          self.subscription_product_feature = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          subscription_product_feature == o.subscription_product_feature
    end
    ...
    def hash
      [subscription_product_feature].hash
    end
