...
module SwaggerClient
  ...
  class POSTAccountResponseType
    ...
    def hash
      [account_id, account_number, contracted_mrr, invoice_id, paid_amount, payment_id, payment_method_id, subscription_id, subscription_number, success, total_contracted_value].hash
    end
