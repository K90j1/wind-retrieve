...
module SwaggerClient
  ...
  class ProxyCreateSubscription
    #  This field can be updated when **Status** is `Draft`. The ID of a valid account. 
    ...
    #  This field can be updated when **Status** is `Draft`. The valid account ID. 
    ...
    def valid?
      ...
      return false if @invoice_owner_id.nil?
      return false if @renewal_setting.nil?
      return true
    end
