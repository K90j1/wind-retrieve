...
module SwaggerClient
  ...
  class GETAccountSummaryTypeBasicInfo
    ...
    def hash
      [account_number, balance, batch, bill_cycle_day, currency, custom_field__c, default_payment_method, id, last_invoice_date, last_payment_amount, last_payment_date, name, status, tags].hash
    end
