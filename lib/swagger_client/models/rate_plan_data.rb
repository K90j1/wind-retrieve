...
module SwaggerClient
  ...
  class RatePlanData
    ...
    def self.swagger_types
      {
        :'rate_plan' => :'Array<RatePlan>',
        :'rate_plan_charge_data' => :'Array<RatePlanChargeData>',
        :'subscription_product_feature_list' => :'Array<SubscriptionProductFeatureList>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RatePlan')
        if (value = attributes[:'RatePlan']).is_a?(Array)
          self.rate_plan = value
        end
      end
      ...
      if attributes.has_key?(:'SubscriptionProductFeatureList')
        if (value = attributes[:'SubscriptionProductFeatureList']).is_a?(Array)
          self.subscription_product_feature_list = value
        end
      end
